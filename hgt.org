...
*** TODO extract lidar clouds within tree buffers  Note: since I have tree points, I"m going to sample from the entire lidar point cloud
  ...
  #  l3 <- readLAS("/home/erker/hgt_data/madison_tree_inventories/hgt/trees_2009_las/ST01245_lc2t70826.las")
    ...
    out <- foreach(i = (1:nrow(uids_df)), .packages = c("stringr","lidR", "rgeos"), .combine = "rbind") %dopar% {  
      ...
      # combine all of them.  this gives a pulse bias.  I may have to do a footprint correction later.
        ...
        saveRDS(res, paste0("/home/erker/hgt_data/madison_tree_inventories/hgt/extracted_heights_bias_tree/", uids_df[i,"uid"], ".rds"))
        return(res)
...
1     2  0.03063911   0.3404281   0.3783620   1.7184697 0.0016842646
2     4  0.06680271   0.7107689   0.7156140   1.8185660 0.0071686677
3     2  0.01864523   0.2153211   0.2897575   1.2264372 0.0006144663
4     3  0.02730856   0.1449364   0.1821908   0.9405857 0.0018609345
5     3  0.01508242   0.1133289   0.3354074   1.1127840 0.0007446298
6     2  0.04597969   0.3293779   0.3786027   1.0424337 0.0037192758
   var_bias16 var_bias09 var_bias05
1 0.042027397 0.05544023  2.2508712
2 0.215096970 0.21543959  1.3773610
3 0.032468270 0.04941980  1.5177271
4 0.009869035 0.01364195  0.4950061
5 0.006697383 0.07646184  0.7555068
6 0.036913813 0.05911220  0.4651718
#+end_example
...
Weighted Residuals:
      1       2       3       4 
 0.4524 -0.4728 -0.1152  0.6559 

Coefficients:
            Estimate Std. Error t value Pr(>|t|)   
(Intercept) 15.88154    0.58209  27.284  0.00134 **
year         0.17175    0.05955   2.884  0.10212   
---
codes:  0 ‘***’ 0.001 ‘**’ 0.01 ‘*’ 0.05 ‘.’ 0.1 ‘ ’ 1

Residual standard error: 0.6602 on 2 degrees of freedom
Multiple R-squared:  0.8062,	Adjusted R-squared:  0.7093 
F-statistic: 8.319 on 1 and 2 DF,  p-value: 0.1021
...
Residuals:
      1       2       3       4 
 0.4850 -0.1743 -0.9758  0.6651 

Coefficients:
            Estimate Std. Error t value Pr(>|t|)   
(Intercept) 17.36298    0.76843  22.595  0.00195 **
year         0.02848    0.09168   0.311  0.78546   
---
codes:  0 ‘***’ 0.001 ‘**’ 0.01 ‘*’ 0.05 ‘.’ 0.1 ‘ ’ 1

Residual standard error: 0.9111 on 2 degrees of freedom
Multiple R-squared:  0.04603,	Adjusted R-squared:  -0.431 
F-statistic: 0.09649 on 1 and 2 DF,  p-value: 0.7855
#+end_example
...
#+begin_src R :exports results :results graphics :file figs/growthrates_lm_f.png :width 1000 :res 120 :bg transparent
...
#+begin_src R :exports results :results graphics :file figs/growthrates_lm_clip_f.png :width 1000 :res 120 :bg transparent
...
#+begin_src R
  ...
  shapefile(trees, "/home/erker/hgt_data/madison_tree_inventories/MadisonTrees_Withlidarextractedheights_growthrates.rds")
...
"Ulmus", "Thuja", "Quercus", "Abies", "Catalpa", "Salix", 
...
#    hg %>%  select(Genus, emp_max2017, emp_max2016, emp_max2009, emp_max2005, n2017, n2016, n2009, n2005, uid) %>% data.frame() %>% toOrg
...
#+begin_src R :exports results :results graphics :file figs/ng_bias.png :width 1000 :bg transparent :res 100 :height 800
...
#+begin_src R :exports results :results graphics :file figs/avg_bias_focus1_otherGenera2_.png :bg transparent :width 1000 :res 120
...
#+begin_src R :exports results :results graphics :file figs/correction_nogrowth_40_f.png :width 1300 :height 800 :bg transparent :res 100
...
#+RESULTS:
[[file:figs/correction_nogrowth_40_f.png]]
...
#+begin_src R :exports results :results graphics :file figs/ng_growthrates_lm_clip.png :width 1000 :res 120 :bg transparent
  ggplot(growth.rates, aes(x = 100 * growth.rate)) + geom_histogram(binwidth = 2, color = base1) +
    terk +
    scale_x_continuous("growth rate (cm/year)", lim = c(-100,100), breaks = c(-100,-50,0, round(mean(growth.rates$growth.rate * 100),1), 50, 100)) +
    geom_vline(data = growth.rates, aes(xintercept = mean(growth.rate)*100), color = red)
...
#+begin_src R :exports results :results graphics :file figs/correction_nogrowth_suspect_high.png :width 1300 :height 800 :bg transparent :res 100
  d <- readRDS("/home/erker/hgt_data/madison_tree_inventories/hgt/extracted_heights_bias_longform.rds")
    dn <- left_join(d, growth.rates)

  dn <- dn[complete.cases(dn),]

      df <- dn[dn$growth.rate > 1,]
