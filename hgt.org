...
#+begin_src R :exports results :results graphics :file figs/tenney_oak1.png :width 1200 :height 300 :res 100 :bg transparent
    ...
    ggplot(d, aes(x = X, y = Z * .3048, color = factor(year))) +
        geom_point(size = .5) +
  #      geom_rug(sides = "l") +
...
#+begin_src R
    ...
    stt <- read.csv("/home/erker/hgt_data/madison_tree_inventories/STTREES.csv", stringsAsFactors = F) %>%
        select(UID, UTILPRES) %>%
        mutate(powerlines = UTILPRES == 4)

    d <- left_join(d, stt) %>%
        mutate(st_po = case_when(street == F ~ "neighborhood",
                                 street == T & powerlines == F ~ "st no pow",
                                 street == T & powerlines == T ~ "st w pow"))

  d <- select(d, -powerlines, -street, -UTILPRES)  
...
#+begin_src R :exports results :results graphics :file figs/corheight2005_growth_bygenus_facet_keyGenera.png :width 1200 
  ggplot(filter(d, Genus %in% c("Acer", "Fraxinus", "Gleditsia", "Quercus", "Pinus", "Picea", "Tilia")), aes(x = cor_max2005, y = growth.rate, color = st_po)) +
      geom_point(alpha = .1) + 
      terk + 
...
1       aspect_200ft          4.774      198512 1.460101e-04
2         aspect_5ft          5.110      203096 4.321155e-05
3                chl          4.508      197393 1.171118e-03
4        cor_max2005          1.040      242974 2.252830e-02
5               elev          3.946      207654 1.257223e-03
6              Genus          1.268       73065 8.388966e-03
7             lignin          3.398      203250 2.085444e-03
8                LMA          4.008      201655 5.127807e-04
9  mean_height_wn20m          2.792      226487 5.585590e-03
10                 N          3.576      205484 1.437910e-03
11      pct_imp_100m          3.304      205565 1.272592e-03
12       pct_imp_20m          2.532      204631 1.476115e-03
13       slope_200ft          4.628      195786 3.445772e-04
14         slope_5ft          4.828      205804 2.128061e-04
15            street          2.696       14781 1.484333e-03
16             Sugar          4.036      201970 1.167285e-03
17           TotPhen          2.854      202942 2.116648e-03
18         tpi_200ft          4.574      200218 2.365676e-04
19           tpi_5ft          4.708      204271 6.995656e-05
   node_purity_increase no_of_trees times_a_root       p_value
1             16.474051         500            0 4.828902e-105
2             15.480831         500            0 4.944521e-230
3             16.638560         500            0  7.236051e-82
4            128.235530         500          175  0.000000e+00
5             20.260352         500            5  0.000000e+00
6             85.472523         500          130  1.000000e+00
7             21.281272         500            1 4.608683e-235
8             17.352873         500           13 1.441143e-185
9             41.753542         500            1  0.000000e+00
10            21.460069         500            0 4.693841e-314
11            21.709408         500           15 3.951421e-317
12            23.165093         500           34 1.439566e-282
13            16.285955         500            0  1.132347e-53
14            16.747249         500            0  0.000000e+00
15             7.423537         500           42  1.000000e+00
16            18.505970         500           12 6.948793e-195
17            23.159458         500           70 4.687866e-225
18            17.435789         500            0 6.132604e-146
19            15.854233         500            2 9.042341e-270
#+end_example
...
#+begin_src R
interactions_frame <- min_depth_interactions(mrf, c("cor_max2005", "Genus", "mean_height_wn20m", "pct_imp_20m", "pct_imp_100m", "lignin", "TotPhen", "N"))
#+end_src

#+begin_src R
saveRDS(interactions_frame, "/home/erker/hgt_data/interactionsframe.rds")
#+end_src
...
Residuals:
     Min       1Q   Median       3Q      Max 
-0.56773 -0.07428 -0.00600  0.06538  0.84763 

Coefficients:
                           Estimate Std. Error t value Pr(>|t|)    
(Intercept)               4.798e-01  2.994e-02  16.023  < 2e-16 ***
st_post no pow           -5.984e-02  2.688e-03 -22.259  < 2e-16 ***
st_post w pow            -3.203e-02  3.546e-03  -9.033  < 2e-16 ***
GenusAcer                -1.407e-01  2.331e-02  -6.034 1.62e-09 ***
GenusBetula              -1.089e-01  2.450e-02  -4.444 8.89e-06 ***
GenusCarya               -7.698e-02  2.615e-02  -2.943 0.003250 ** 
GenusCatalpa             -2.181e-02  2.715e-02  -0.803 0.421718    
GenusCeltis              -1.390e-01  2.402e-02  -5.786 7.29e-09 ***
GenusFraxinus            -9.373e-02  2.331e-02  -4.021 5.82e-05 ***
GenusGinkgo              -4.901e-02  2.792e-02  -1.756 0.079186 .  
GenusGleditsia           -4.801e-02  2.335e-02  -2.056 0.039811 *  
GenusGymnocladus          1.657e-02  5.175e-02   0.320 0.748850    
GenusJuglans             -4.178e-02  2.462e-02  -1.697 0.089619 .  
GenusPicea               -2.200e-04  2.382e-02  -0.009 0.992629    
GenusPinus                8.341e-02  2.435e-02   3.426 0.000614 ***
GenusPlatanus             7.783e-02  3.451e-02   2.255 0.024117 *  
GenusPopulus             -6.802e-02  2.575e-02  -2.642 0.008255 ** 
GenusQuercus             -1.379e-01  2.353e-02  -5.860 4.68e-09 ***
GenusRobinia             -9.456e-04  2.577e-02  -0.037 0.970731    
GenusSalix               -9.469e-02  5.510e-02  -1.718 0.085727 .  
GenusThuja               -5.379e-02  2.578e-02  -2.086 0.036949 *  
GenusTilia               -9.460e-04  2.348e-02  -0.040 0.967861    
GenusUlmus               -1.365e-02  2.398e-02  -0.569 0.569157    
cor_max2005              -3.079e-02  3.248e-04 -94.775  < 2e-16 ***
tpi_5ft                  -1.099e-02  3.716e-03  -2.957 0.003114 ** 
slope_5ft                -8.747e-03  1.604e-02  -0.545 0.585499    
aspect_trans_5ft          1.466e-03  1.230e-03   1.192 0.233236    
tpi_200ft                -1.931e-03  2.910e-04  -6.635 3.32e-11 ***
slope_200ft               1.863e-03  3.845e-02   0.048 0.961345    
aspect_trans_200ft       -5.594e-03  1.208e-03  -4.632 3.64e-06 ***
elev                     -2.925e-04  4.936e-05  -5.927 3.13e-09 ***
mean_height_wn20m         2.586e-02  5.750e-04  44.978  < 2e-16 ***
pct_imp_20m               8.184e-02  1.294e-02   6.326 2.56e-10 ***
pct_imp_100m              3.524e-02  1.318e-02   2.674 0.007500 ** 
TotPhen                  -1.367e-02  2.129e-03  -6.424 1.36e-10 ***
N                        -4.393e-02  1.662e-03 -26.424  < 2e-16 ***
Sugar                    -1.750e-02  1.965e-03  -8.904  < 2e-16 ***
LMA                      -7.657e-03  1.286e-03  -5.952 2.68e-09 ***
lignin                   -2.112e-02  2.156e-03  -9.800  < 2e-16 ***
chl                       2.266e-02  1.994e-03  11.364  < 2e-16 ***
pct_imp_20m:pct_imp_100m -2.517e-01  2.385e-02 -10.556  < 2e-16 ***
---
codes:  0 ‘***’ 0.001 ‘**’ 0.01 ‘*’ 0.05 ‘.’ 0.1 ‘ ’ 1

Residual standard error: 0.1224 on 21412 degrees of freedom
  (20483 observations deleted due to missingness)
Multiple R-squared:  0.4351,	Adjusted R-squared:  0.434 
F-statistic: 412.3 on 40 and 21412 DF,  p-value: < 2.2e-16
#+end_example
...
Residuals:
     Min       1Q   Median       3Q      Max 
-0.48984 -0.08190 -0.00761  0.07300  0.96538 

Coefficients:
                           Estimate Std. Error t value Pr(>|t|)    
(Intercept)               0.3604695  0.0199628  18.057  < 2e-16 ***
st_post no pow           -0.0691478  0.0026733 -25.866  < 2e-16 ***
st_post w pow            -0.0417007  0.0036444 -11.442  < 2e-16 ***
cor_max2005              -0.0320281  0.0003360 -95.317  < 2e-16 ***
tpi_5ft                  -0.0180995  0.0039585  -4.572 4.85e-06 ***
slope_5ft                 0.0009136  0.0169987   0.054 0.957138    
aspect_trans_5ft          0.0017979  0.0013109   1.371 0.170254    
tpi_200ft                -0.0021564  0.0003098  -6.962 3.46e-12 ***
slope_200ft               0.0019244  0.0407252   0.047 0.962312    
aspect_trans_200ft       -0.0023433  0.0012855  -1.823 0.068339 .  
elev                     -0.0001742  0.0000523  -3.331 0.000867 ***
mean_height_wn20m         0.0269662  0.0006082  44.336  < 2e-16 ***
pct_imp_20m               0.0692714  0.0136741   5.066 4.10e-07 ***
pct_imp_100m              0.0590566  0.0139256   4.241 2.24e-05 ***
TotPhen                  -0.0515129  0.0017536 -29.376  < 2e-16 ***
N                        -0.0386502  0.0017228 -22.435  < 2e-16 ***
Sugar                    -0.0010341  0.0019432  -0.532 0.594624    
LMA                      -0.0057910  0.0012955  -4.470 7.86e-06 ***
lignin                   -0.0444015  0.0021008 -21.136  < 2e-16 ***
chl                       0.0216641  0.0019436  11.146  < 2e-16 ***
pct_imp_20m:pct_imp_100m -0.2377602  0.0251444  -9.456  < 2e-16 ***
---
codes:  0 ‘***’ 0.001 ‘**’ 0.01 ‘*’ 0.05 ‘.’ 0.1 ‘ ’ 1

Residual standard error: 0.1306 on 21432 degrees of freedom
  (20483 observations deleted due to missingness)
Multiple R-squared:  0.3558,	Adjusted R-squared:  0.3552 
F-statistic:   592 on 20 and 21432 DF,  p-value: < 2.2e-16
#+end_example
...
Residuals:
     Min       1Q   Median       3Q      Max 
-0.54247 -0.07252 -0.00568  0.06427  0.83462 

Coefficients:
                           Estimate Std. Error t value Pr(>|t|)    
(Intercept)               1.241e-01  2.934e-02   4.229 2.35e-05 ***
st_post no pow           -5.603e-02  2.654e-03 -21.115  < 2e-16 ***
st_post w pow            -2.968e-02  3.499e-03  -8.483  < 2e-16 ***
GenusAcer                -1.428e-01  2.297e-02  -6.218 5.11e-10 ***
GenusBetula              -1.056e-01  2.414e-02  -4.375 1.22e-05 ***
GenusCarya               -8.831e-02  2.577e-02  -3.427 0.000612 ***
GenusCatalpa             -2.934e-02  2.675e-02  -1.097 0.272735    
GenusCeltis              -1.402e-01  2.366e-02  -5.927 3.14e-09 ***
GenusFraxinus            -9.277e-02  2.297e-02  -4.040 5.37e-05 ***
GenusGinkgo              -4.058e-02  2.751e-02  -1.475 0.140149    
GenusGleditsia           -5.226e-02  2.301e-02  -2.272 0.023122 *  
GenusGymnocladus          8.308e-03  5.099e-02   0.163 0.870567    
GenusJuglans             -4.876e-02  2.426e-02  -2.010 0.044403 *  
GenusPicea               -1.975e-03  2.347e-02  -0.084 0.932924    
GenusPinus                7.769e-02  2.399e-02   3.239 0.001203 ** 
GenusPlatanus             6.205e-02  3.401e-02   1.825 0.068071 .  
GenusPopulus             -1.019e-01  2.548e-02  -3.999 6.38e-05 ***
GenusQuercus             -1.501e-01  2.318e-02  -6.475 9.72e-11 ***
GenusRobinia             -8.382e-03  2.539e-02  -0.330 0.741316    
GenusSalix               -1.021e-01  5.429e-02  -1.880 0.060089 .  
GenusThuja               -5.669e-02  2.540e-02  -2.232 0.025648 *  
GenusTilia               -3.045e-03  2.314e-02  -0.132 0.895280    
GenusUlmus               -2.315e-02  2.363e-02  -0.980 0.327219    
poly(cor_max2005, 4)1    -2.967e+01  3.206e-01 -92.529  < 2e-16 ***
poly(cor_max2005, 4)2     7.027e+00  2.783e-01  25.254  < 2e-16 ***
poly(cor_max2005, 4)3    -3.473e+00  2.350e-01 -14.781  < 2e-16 ***
poly(cor_max2005, 4)4     1.564e+00  1.849e-01   8.459  < 2e-16 ***
tpi_5ft                  -1.101e-02  3.661e-03  -3.007 0.002645 ** 
slope_5ft                -1.192e-02  1.580e-02  -0.754 0.450776    
aspect_trans_5ft          1.427e-03  1.212e-03   1.178 0.238912    
tpi_200ft                -1.604e-03  2.872e-04  -5.584 2.38e-08 ***
slope_200ft              -2.690e-02  3.793e-02  -0.709 0.478268    
aspect_trans_200ft       -5.471e-03  1.190e-03  -4.597 4.30e-06 ***
elev                     -3.440e-04  4.882e-05  -7.047 1.88e-12 ***
mean_height_wn20m         2.426e-02  5.705e-04  42.519  < 2e-16 ***
pct_imp_20m               7.306e-02  1.275e-02   5.729 1.02e-08 ***
pct_imp_100m              3.353e-02  1.300e-02   2.579 0.009930 ** 
TotPhen                  -1.311e-02  2.098e-03  -6.248 4.24e-10 ***
N                        -4.112e-02  1.644e-03 -25.020  < 2e-16 ***
Sugar                    -1.754e-02  1.936e-03  -9.057  < 2e-16 ***
LMA                      -5.435e-03  1.271e-03  -4.277 1.90e-05 ***
lignin                   -2.016e-02  2.124e-03  -9.489  < 2e-16 ***
chl                       1.973e-02  1.971e-03  10.013  < 2e-16 ***
pct_imp_20m:pct_imp_100m -2.451e-01  2.353e-02 -10.416  < 2e-16 ***
---
codes:  0 ‘***’ 0.001 ‘**’ 0.01 ‘*’ 0.05 ‘.’ 0.1 ‘ ’ 1

Residual standard error: 0.1206 on 21409 degrees of freedom
  (20483 observations deleted due to missingness)
Multiple R-squared:  0.4517,	Adjusted R-squared:  0.4506 
F-statistic: 410.2 on 43 and 21409 DF,  p-value: < 2.2e-16
#+end_example
...
Residuals:
     Min       1Q   Median       3Q      Max 
-0.66799 -0.08062 -0.00593  0.07272  0.89905 

Coefficients:
                           Estimate Std. Error t value Pr(>|t|)    
(Intercept)               3.469e-02  2.285e-02   1.518 0.128950    
st_post no pow           -5.627e-02  2.507e-03 -22.441  < 2e-16 ***
st_post w pow            -4.936e-02  3.105e-03 -15.898  < 2e-16 ***
GenusAcer                -1.813e-01  1.866e-02  -9.717  < 2e-16 ***
GenusBetula              -1.432e-01  1.952e-02  -7.336 2.24e-13 ***
GenusCarya               -1.039e-01  2.202e-02  -4.720 2.36e-06 ***
GenusCatalpa             -3.672e-02  2.366e-02  -1.552 0.120641    
GenusCeltis              -1.590e-01  1.930e-02  -8.236  < 2e-16 ***
GenusFraxinus            -9.234e-02  1.868e-02  -4.943 7.72e-07 ***
GenusGinkgo              -4.960e-02  2.197e-02  -2.257 0.024002 *  
GenusGleditsia           -5.341e-02  1.870e-02  -2.855 0.004302 ** 
GenusGymnocladus         -1.650e-02  4.541e-02  -0.363 0.716391    
GenusJuglans             -7.216e-02  2.017e-02  -3.578 0.000347 ***
GenusPicea               -2.613e-02  1.913e-02  -1.366 0.171929    
GenusPinus                2.297e-02  1.970e-02   1.166 0.243605    
GenusPlatanus             3.445e-02  3.234e-02   1.065 0.286742    
GenusPopulus             -1.035e-01  2.192e-02  -4.721 2.35e-06 ***
GenusQuercus             -1.624e-01  1.898e-02  -8.555  < 2e-16 ***
GenusRobinia             -1.042e-02  2.178e-02  -0.479 0.632199    
GenusSalix               -1.171e-02  4.380e-02  -0.267 0.789247    
GenusThuja               -1.191e-01  2.019e-02  -5.898 3.71e-09 ***
GenusTilia               -2.840e-02  1.876e-02  -1.514 0.130119    
GenusUlmus               -1.025e-02  1.930e-02  -0.531 0.595370    
poly(cor_max2005, 4)1    -1.841e+01  1.992e-01 -92.415  < 2e-16 ***
poly(cor_max2005, 4)2    -9.003e-01  1.463e-01  -6.152 7.74e-10 ***
poly(cor_max2005, 4)3     1.112e+00  1.393e-01   7.984 1.45e-15 ***
poly(cor_max2005, 4)4    -7.025e-01  1.383e-01  -5.081 3.78e-07 ***
tpi_5ft                  -3.287e-03  3.088e-03  -1.064 0.287167    
aspect_trans_5ft          1.079e-03  9.763e-04   1.105 0.268973    
tpi_200ft                -1.360e-03  2.423e-04  -5.614 1.99e-08 ***
aspect_trans_200ft       -2.235e-03  9.539e-04  -2.343 0.019119 *  
elev                     -1.665e-04  3.544e-05  -4.697 2.65e-06 ***
mean_height_wn20m         2.468e-02  4.577e-04  53.921  < 2e-16 ***
pct_imp_20m               9.049e-02  9.388e-03   9.640  < 2e-16 ***
pct_imp_100m              8.138e-02  1.012e-02   8.045 8.85e-16 ***
pct_imp_20m:pct_imp_100m -3.586e-01  1.680e-02 -21.346  < 2e-16 ***
---
codes:  0 ‘***’ 0.001 ‘**’ 0.01 ‘*’ 0.05 ‘.’ 0.1 ‘ ’ 1

Residual standard error: 0.1374 on 41889 degrees of freedom
  (11 observations deleted due to missingness)
Multiple R-squared:  0.3236,	Adjusted R-squared:  0.323 
F-statistic: 572.5 on 35 and 41889 DF,  p-value: < 2.2e-16
#+end_example
...
#+begin_example
                           traits    notraits
(Intercept)             1.5182836   1.7805518
st_post no pow        -22.4413703 -20.9719112
st_post w pow         -15.8983637  -8.5547574
GenusAcer              -9.7173564  -6.2247720
GenusBetula            -7.3358335  -4.3902262
GenusCarya             -4.7204228  -3.2678039
GenusCatalpa           -1.5521186  -1.0858039
GenusCeltis            -8.2361419  -5.9680273
GenusFraxinus          -4.9431076  -4.0445424
GenusGinkgo            -2.2571851  -1.4848838
GenusGleditsia         -2.8553016  -2.2801486
GenusGymnocladus       -0.3632890   0.1508763
GenusJuglans           -3.5778302  -2.0355056
GenusPicea             -1.3660564   0.1765500
GenusPinus              1.1660401   3.2397816
GenusPlatanus           1.0653091   1.8224997
GenusPopulus           -4.7211139  -3.9031534
GenusQuercus           -8.5549366  -6.5213403
GenusRobinia           -0.4786376  -0.3955791
GenusSalix             -0.2672900  -1.2489657
GenusThuja             -5.8979444  -2.2436456
GenusTilia             -1.5136607  -0.1295291
GenusUlmus             -0.5310747  -1.0003863
poly(cor_max2005, 4)1 -92.4147983 -92.2066810
poly(cor_max2005, 4)2  -6.1515780  20.5505166
poly(cor_max2005, 4)3   7.9844602 -12.0336026
poly(cor_max2005, 4)4  -5.0805303   8.4014266
tpi_5ft                -1.0643696  -3.0941459
aspect_trans_5ft        1.1054460   1.0259646
tpi_200ft              -5.6138183  -5.6210209
aspect_trans_200ft     -2.3433025  -4.4744282
elev                   -4.6971706  -7.0583286
mean_height_wn20m      53.9213566  42.1793998
pct_imp_20m             9.6397279   5.7457250
pct_imp_100m            8.0449399   2.9292608
#+end_example
...
Residuals:
     Min       1Q   Median       3Q      Max 
-0.54409 -0.07256 -0.00562  0.06425  0.83474 

Coefficients:
                           Estimate Std. Error t value Pr(>|t|)    
(Intercept)               5.211e-02  2.927e-02   1.781  0.07500 .  
st_post no pow           -5.656e-02  2.697e-03 -20.972  < 2e-16 ***
st_post w pow            -3.017e-02  3.527e-03  -8.555  < 2e-16 ***
GenusAcer                -1.429e-01  2.295e-02  -6.225 4.91e-10 ***
GenusBetula              -1.066e-01  2.427e-02  -4.390 1.14e-05 ***
GenusCarya               -8.700e-02  2.662e-02  -3.268  0.00109 ** 
GenusCatalpa             -2.912e-02  2.682e-02  -1.086  0.27758    
GenusCeltis              -1.411e-01  2.364e-02  -5.968 2.44e-09 ***
GenusFraxinus            -9.284e-02  2.295e-02  -4.045 5.26e-05 ***
GenusGinkgo              -4.081e-02  2.749e-02  -1.485  0.13759    
GenusGleditsia           -5.242e-02  2.299e-02  -2.280  0.02261 *  
GenusGymnocladus          7.687e-03  5.095e-02   0.151  0.88007    
GenusJuglans             -4.933e-02  2.424e-02  -2.036  0.04181 *  
GenusPicea                4.156e-03  2.354e-02   0.177  0.85986    
GenusPinus                7.766e-02  2.397e-02   3.240  0.00120 ** 
GenusPlatanus             6.192e-02  3.397e-02   1.822  0.06839 .  
GenusPopulus             -9.946e-02  2.548e-02  -3.903 9.52e-05 ***
GenusQuercus             -1.511e-01  2.317e-02  -6.521 7.13e-11 ***
GenusRobinia             -1.003e-02  2.535e-02  -0.396  0.69242    
GenusSalix               -8.052e-02  6.447e-02  -1.249  0.21169    
GenusThuja               -5.694e-02  2.538e-02  -2.244  0.02487 *  
GenusTilia               -2.995e-03  2.312e-02  -0.130  0.89694    
GenusUlmus               -2.363e-02  2.362e-02  -1.000  0.31714    
poly(cor_max2005, 4)1    -1.547e+01  1.677e-01 -92.207  < 2e-16 ***
poly(cor_max2005, 4)2     2.631e+00  1.280e-01  20.551  < 2e-16 ***
poly(cor_max2005, 4)3    -1.477e+00  1.228e-01 -12.034  < 2e-16 ***
poly(cor_max2005, 4)4     1.020e+00  1.214e-01   8.401  < 2e-16 ***
tpi_5ft                  -1.137e-02  3.675e-03  -3.094  0.00198 ** 
aspect_trans_5ft          1.248e-03  1.216e-03   1.026  0.30492    
tpi_200ft                -1.614e-03  2.872e-04  -5.621 1.92e-08 ***
aspect_trans_200ft       -5.342e-03  1.194e-03  -4.474 7.70e-06 ***
elev                     -3.438e-04  4.871e-05  -7.058 1.74e-12 ***
mean_height_wn20m         2.415e-02  5.726e-04  42.179  < 2e-16 ***
pct_imp_20m               7.339e-02  1.277e-02   5.746 9.28e-09 ***
pct_imp_100m              3.712e-02  1.267e-02   2.929  0.00340 ** 
TotPhen                  -1.323e-02  2.104e-03  -6.290 3.23e-10 ***
N                        -4.117e-02  1.647e-03 -24.997  < 2e-16 ***
Sugar                    -1.751e-02  1.942e-03  -9.016  < 2e-16 ***
LMA                      -5.765e-03  1.273e-03  -4.529 5.96e-06 ***
lignin                   -2.013e-02  2.129e-03  -9.454  < 2e-16 ***
chl                       1.932e-02  1.979e-03   9.767  < 2e-16 ***
pct_imp_20m:pct_imp_100m -2.485e-01  2.333e-02 -10.652  < 2e-16 ***
---
codes:  0 ‘***’ 0.001 ‘**’ 0.01 ‘*’ 0.05 ‘.’ 0.1 ‘ ’ 1

Residual standard error: 0.1205 on 21202 degrees of freedom
Multiple R-squared:  0.4526,	Adjusted R-squared:  0.4516 
F-statistic: 427.6 on 41 and 21202 DF,  p-value: < 2.2e-16
#+end_example
...
Residuals:
     Min       1Q   Median       3Q      Max 
-0.48671 -0.07865 -0.00680  0.07103  0.91362 

Coefficients:
                                       Estimate Std. Error t value Pr(>|t|)    
(Intercept)                          -8.700e-02  1.939e-02  -4.487 7.25e-06 ***
coniferTRUE                           2.486e-01  1.294e-01   1.921  0.05477 .  
st_post no pow                       -5.195e-02  2.786e-03 -18.648  < 2e-16 ***
st_post w pow                        -2.636e-02  3.686e-03  -7.152 8.80e-13 ***
poly(cor_max2005, 4)1                -1.592e+01  1.759e-01 -90.504  < 2e-16 ***
poly(cor_max2005, 4)2                 2.420e+00  1.334e-01  18.136  < 2e-16 ***
poly(cor_max2005, 4)3                -1.701e+00  1.295e-01 -13.136  < 2e-16 ***
poly(cor_max2005, 4)4                 1.343e+00  1.293e-01  10.387  < 2e-16 ***
tpi_5ft                              -1.641e-02  3.904e-03  -4.204 2.64e-05 ***
tpi_200ft                            -1.610e-03  3.085e-04  -5.220 1.81e-07 ***
aspect_trans_200ft                   -1.504e-03  1.209e-03  -1.244  0.21354    
elev                                 -3.104e-04  5.172e-05  -6.001 2.00e-09 ***
mean_height_wn20m                     2.556e-02  6.169e-04  41.436  < 2e-16 ***
pct_imp_20m                           6.956e-02  1.363e-02   5.102 3.39e-07 ***
pct_imp_100m                          6.849e-02  1.338e-02   5.121 3.07e-07 ***
TotPhen                              -4.550e-02  1.754e-03 -25.937  < 2e-16 ***
N                                    -2.830e-02  1.746e-03 -16.214  < 2e-16 ***
Sugar                                -1.996e-03  1.922e-03  -1.039  0.29903    
LMA                                  -7.623e-03  1.299e-03  -5.869 4.45e-09 ***
lignin                               -3.897e-02  2.108e-03 -18.491  < 2e-16 ***
chl                                   9.182e-03  1.983e-03   4.630 3.68e-06 ***
pct_imp_20m:pct_imp_100m             -2.385e-01  2.459e-02  -9.701  < 2e-16 ***
coniferTRUE:st_post no pow           -3.107e-02  1.296e-02  -2.398  0.01651 *  
coniferTRUE:st_post w pow            -2.213e-02  2.725e-02  -0.812  0.41681    
coniferTRUE:poly(cor_max2005, 4)1    -2.504e+00  9.121e-01  -2.745  0.00605 ** 
coniferTRUE:poly(cor_max2005, 4)2     2.438e+00  1.386e+00   1.759  0.07864 .  
coniferTRUE:poly(cor_max2005, 4)3     1.191e+00  2.069e+00   0.576  0.56487    
coniferTRUE:poly(cor_max2005, 4)4    -2.229e+00  1.698e+00  -1.312  0.18942    
coniferTRUE:tpi_5ft                   5.770e-03  2.958e-02   0.195  0.84536    
coniferTRUE:tpi_200ft                -5.938e-03  1.524e-03  -3.896 9.81e-05 ***
coniferTRUE:aspect_trans_200ft        7.521e-04  7.048e-03   0.107  0.91502    
coniferTRUE:elev                     -4.056e-04  3.845e-04  -1.055  0.29153    
coniferTRUE:mean_height_wn20m        -2.436e-03  2.787e-03  -0.874  0.38221    
coniferTRUE:pct_imp_20m               9.565e-02  8.100e-02   1.181  0.23764    
coniferTRUE:pct_imp_100m              1.203e-02  8.762e-02   0.137  0.89078    
coniferTRUE:TotPhen                   1.130e-02  1.163e-02   0.972  0.33117    
coniferTRUE:N                        -4.400e-02  9.131e-03  -4.819 1.45e-06 ***
coniferTRUE:Sugar                    -2.675e-02  1.149e-02  -2.329  0.01987 *  
coniferTRUE:LMA                       9.760e-03  7.248e-03   1.347  0.17811    
coniferTRUE:lignin                    9.048e-03  1.123e-02   0.806  0.42031    
coniferTRUE:chl                       1.872e-02  1.125e-02   1.664  0.09611 .  
coniferTRUE:pct_imp_20m:pct_imp_100m -2.773e-01  1.947e-01  -1.424  0.15434    
---
codes:  0 ‘***’ 0.001 ‘**’ 0.01 ‘*’ 0.05 ‘.’ 0.1 ‘ ’ 1

Residual standard error: 0.127 on 21202 degrees of freedom
Multiple R-squared:  0.3916,	Adjusted R-squared:  0.3904 
F-statistic: 332.8 on 41 and 21202 DF,  p-value: < 2.2e-16
#+end_example
...
Residuals:
     Min       1Q   Median       3Q      Max 
-0.49205 -0.07154 -0.00537  0.06289  0.82338 

Coefficients:
                           Estimate Std. Error t value Pr(>|t|)    
(Intercept)              -9.667e-02  1.814e-02  -5.329 9.98e-08 ***
st_post no pow           -5.482e-02  2.727e-03 -20.099  < 2e-16 ***
st_post w pow            -2.872e-02  3.524e-03  -8.149 3.87e-16 ***
GenusBetula               4.025e-02  8.624e-03   4.667 3.08e-06 ***
GenusCarya                5.523e-02  1.347e-02   4.101 4.13e-05 ***
GenusCatalpa              1.159e-01  1.403e-02   8.259  < 2e-16 ***
GenusCeltis               3.685e-03  6.412e-03   0.575 0.565504    
GenusFraxinus             5.161e-02  2.656e-03  19.431  < 2e-16 ***
GenusGinkgo               1.066e-01  1.517e-02   7.025 2.20e-12 ***
GenusGleditsia            9.249e-02  3.139e-03  29.464  < 2e-16 ***
GenusGymnocladus          1.529e-01  4.467e-02   3.424 0.000618 ***
GenusJuglans              9.449e-02  8.267e-03  11.429  < 2e-16 ***
GenusPlatanus             2.075e-01  2.477e-02   8.380  < 2e-16 ***
GenusPopulus              4.766e-02  1.165e-02   4.090 4.34e-05 ***
GenusQuercus             -7.363e-03  4.508e-03  -1.633 0.102386    
GenusRobinia              1.323e-01  1.090e-02  12.142  < 2e-16 ***
GenusSalix                6.308e-02  5.906e-02   1.068 0.285523    
GenusThuja                8.990e-02  1.130e-02   7.955 1.88e-15 ***
GenusTilia                1.402e-01  3.609e-03  38.833  < 2e-16 ***
GenusUlmus                1.208e-01  6.294e-03  19.187  < 2e-16 ***
poly(cor_max2005, 4)1    -1.529e+01  1.693e-01 -90.296  < 2e-16 ***
poly(cor_max2005, 4)2     2.584e+00  1.276e-01  20.261  < 2e-16 ***
poly(cor_max2005, 4)3    -1.525e+00  1.217e-01 -12.531  < 2e-16 ***
poly(cor_max2005, 4)4     1.055e+00  1.204e-01   8.764  < 2e-16 ***
tpi_5ft                  -1.185e-02  3.632e-03  -3.262 0.001107 ** 
tpi_200ft                -1.311e-03  2.875e-04  -4.562 5.10e-06 ***
aspect_trans_200ft       -4.874e-03  1.127e-03  -4.325 1.53e-05 ***
elev                     -3.424e-04  4.823e-05  -7.098 1.30e-12 ***
mean_height_wn20m         2.436e-02  5.773e-04  42.205  < 2e-16 ***
pct_imp_20m               7.616e-02  1.280e-02   5.951 2.71e-09 ***
pct_imp_100m              3.818e-02  1.259e-02   3.032 0.002430 ** 
TotPhen                  -1.087e-02  2.112e-03  -5.147 2.67e-07 ***
N                        -3.883e-02  1.653e-03 -23.490  < 2e-16 ***
Sugar                    -1.729e-02  1.934e-03  -8.938  < 2e-16 ***
LMA                      -6.672e-03  1.274e-03  -5.237 1.65e-07 ***
lignin                   -1.939e-02  2.139e-03  -9.063  < 2e-16 ***
chl                       1.816e-02  1.981e-03   9.165  < 2e-16 ***
pct_imp_20m:pct_imp_100m -2.483e-01  2.318e-02 -10.708  < 2e-16 ***
---
codes:  0 ‘***’ 0.001 ‘**’ 0.01 ‘*’ 0.05 ‘.’ 0.1 ‘ ’ 1

Residual standard error: 0.118 on 20495 degrees of freedom
Multiple R-squared:  0.4326,	Adjusted R-squared:  0.4316 
F-statistic: 422.3 on 37 and 20495 DF,  p-value: < 2.2e-16
#+end_example
...
Residuals:
     Min       1Q   Median       3Q      Max 
-0.49351 -0.10868 -0.00063  0.10161  0.88104 

Coefficients:
                           Estimate Std. Error t value Pr(>|t|)    
(Intercept)               1.569e-01  1.776e-01   0.883 0.377351    
st_post no pow           -8.850e-02  1.726e-02  -5.128 3.81e-07 ***
st_post w pow            -4.165e-02  3.680e-02  -1.132 0.258079    
GenusPicea               -5.889e-03  3.469e-02  -0.170 0.865237    
GenusPinus                7.165e-02  3.543e-02   2.022 0.043545 *  
poly(cor_max2005, 4)1    -1.781e+01  1.224e+00 -14.546  < 2e-16 ***
poly(cor_max2005, 4)2     5.125e+00  1.889e+00   2.714 0.006817 ** 
poly(cor_max2005, 4)3     8.933e-01  2.838e+00   0.315 0.753034    
poly(cor_max2005, 4)4     4.054e-01  2.320e+00   0.175 0.861360    
tpi_5ft                  -1.338e-02  3.993e-02  -0.335 0.737660    
tpi_200ft                -7.213e-03  2.034e-03  -3.546 0.000418 ***
aspect_trans_200ft       -3.293e-03  9.512e-03  -0.346 0.729314    
elev                     -7.279e-04  5.188e-04  -1.403 0.161007    
mean_height_wn20m         2.181e-02  3.708e-03   5.882 6.32e-09 ***
pct_imp_20m               1.855e-01  1.088e-01   1.706 0.088508 .  
pct_imp_100m              9.419e-02  1.180e-01   0.798 0.425086    
TotPhen                  -2.497e-02  1.576e-02  -1.584 0.113610    
N                        -7.278e-02  1.221e-02  -5.962 3.99e-09 ***
Sugar                    -3.110e-02  1.544e-02  -2.014 0.044395 *  
LMA                       2.080e-03  9.713e-03   0.214 0.830535    
lignin                   -2.049e-02  1.515e-02  -1.353 0.176505    
chl                       3.502e-02  1.517e-02   2.309 0.021233 *  
pct_imp_20m:pct_imp_100m -6.006e-01  2.637e-01  -2.278 0.023045 *  
---
codes:  0 ‘***’ 0.001 ‘**’ 0.01 ‘*’ 0.05 ‘.’ 0.1 ‘ ’ 1

Residual standard error: 0.1729 on 688 degrees of freedom
Multiple R-squared:  0.4493,	Adjusted R-squared:  0.4317 
F-statistic: 25.51 on 22 and 688 DF,  p-value: < 2.2e-16
#+end_example
...
#+BEGIN_SRC org
  ...
  |-----------------------------------------+-----------------------+----------------------+----------------------+----------------------+----------|
  | (Intercept)                             |    -0.119338188490862 |   0.0601037558749918 |    -1.98553629059506 |   0.0470977182634544 | FALSE    |
  | GenusAcer                               |    -0.129711940954096 |     0.02282794251241 |    -5.68215645731456 | 1.34754319486366e-08 | TRUE     |
  | GenusBetula                             |   -0.0998393985737899 |   0.0240929741836299 |    -4.14392170152352 | 3.42743075881522e-05 | TRUE     |
  | GenusCarya                              |   -0.0702150123623262 |   0.0264919439010059 |     -2.6504288482832 |  0.00804494481175458 | TRUE     |
  | GenusCatalpa                            |  -0.00315031737010191 |   0.0267334928257412 |   -0.117841592590869 |    0.906194291130894 | FALSE    |
  | GenusCeltis                             |    -0.125216546568453 |   0.0235152196892295 |    -5.32491502198489 | 1.02030361309307e-07 | TRUE     |
  | GenusFraxinus                           |    -0.076202458467972 |   0.0228289873644205 |    -3.33796927789864 | 0.000845385449029052 | TRUE     |
  | GenusGinkgo                             |   -0.0267672497942801 |   0.0273165243286164 |   -0.979892224657554 |    0.327150520685799 | FALSE    |
  | GenusGleditsia                          |   -0.0346833794425088 |    0.022863204617269 |    -1.51699554035009 |    0.129282743690531 | FALSE    |
  | GenusGymnocladus                        |    0.0327405033154916 |   0.0505536370152762 |    0.647638928641239 |    0.517225536699585 | FALSE    |
  | GenusJuglans                            |   -0.0393563082792033 |   0.0241421434398027 |    -1.63019113764013 |    0.103075985280852 | FALSE    |
  | GenusPicea                              |   0.00297527869372086 |   0.0233528334064619 |    0.127405469046749 |    0.898620698091826 | FALSE    |
  | GenusPinus                              |    0.0780656183179727 |   0.0237740122659957 |     3.28365348871427 |  0.00102637038140797 | TRUE     |
  | GenusPlatanus                           |    0.0746341378018302 |   0.0338084701445832 |     2.20755738081772 |   0.0272858287919252 | FALSE    |
  | GenusPopulus                            |   -0.0773545156913026 |   0.0253762611008867 |    -3.04830232411975 |  0.00230422169129848 | TRUE     |
  | GenusQuercus                            |     -0.13347227489421 |   0.0230429922378148 |    -5.79231523044889 | 7.04058984493685e-09 | TRUE     |
  | GenusRobinia                            |   0.00100634973414743 |   0.0252083519546345 |   0.0399212822781306 |    0.968156260324772 | FALSE    |
  | GenusSalix                              |   -0.0748888925700487 |   0.0638818658658688 |     -1.1723028367282 |    0.241088686774751 | FALSE    |
  | GenusThuja                              |   -0.0531040198705332 |   0.0251678588126646 |    -2.10999355431106 |   0.0348706147995636 | FALSE    |
  | GenusTilia                              |    0.0106282748238778 |   0.0229966481689052 |    0.462166257700495 |    0.643966848619551 | FALSE    |
  | GenusUlmus                              |  -0.00629667844791437 |   0.0234988307682917 |   -0.267957095823288 |    0.788734954950802 | FALSE    |
  | st_post no pow                          |     0.127400069403819 |   0.0586075736619933 |     2.17378167092486 |   0.0297325806819381 | FALSE    |
  | st_post w pow                           |    0.0596277659311395 |   0.0892994252223198 |    0.667728440386825 |      0.5043142321686 | FALSE    |
  | poly(cor_max2005, 4)1                   |     -18.0069767574836 |    0.349921510816783 |    -51.4600451839955 |                    0 | TRUE     |
  | poly(cor_max2005, 4)2                   |      3.83740431535251 |    0.268087166971057 |     14.3140171859356 | 2.94164519049195e-46 | TRUE     |
  | poly(cor_max2005, 4)3                   |     -1.50745121732409 |    0.230554237693249 |    -6.53838000292903 | 6.36073774828601e-11 | TRUE     |
  | poly(cor_max2005, 4)4                   |     0.936336432374189 |    0.193852214221959 |     4.83015598316608 | 1.37379803552911e-06 | TRUE     |
  | tpi_5ft                                 |   -0.0303689270136622 |  0.00880978138340978 |    -3.44718281782244 | 0.000567565629811826 | TRUE     |
  | tpi_200ft                               |  -0.00253363853706961 | 0.000545201551434342 |    -4.64715944113511 |  3.3856438292362e-06 | TRUE     |
  | aspect_trans_200ft                      |  -0.00427477065705205 |  0.00282298732027076 |    -1.51427200057067 |    0.129971798031624 | FALSE    |
  | elev                                    |  0.000239990375942255 | 0.000172566033624979 |     1.39071618499271 |    0.164326127635858 | FALSE    |
  | mean_height_wn20m                       |    0.0220464130400964 |  0.00111343836358069 |     19.8002994698312 | 1.79463479002341e-86 | TRUE     |
  | pct_imp_20m                             |    0.0508128848633109 |   0.0309355819295325 |     1.64253851694326 |    0.100493304719418 | FALSE    |
  | pct_imp_100m                            |     0.149671999304538 |   0.0247491214224142 |     6.04756818433912 | 1.49514809671778e-09 | TRUE     |
  | TotPhen                                 |   0.00133191930201679 |  0.00416381691503935 |    0.319879410933274 |    0.749062903332561 | FALSE    |
  | N                                       |   -0.0614000517117174 |   0.0040518451361649 |    -15.1536027780748 | 1.33826320314442e-51 | TRUE     |
  | Sugar                                   |   -0.0272708436807638 |  0.00456712202186699 |    -5.97112219690942 | 2.39386663766886e-09 | TRUE     |
  | LMA                                     |  -0.00489232933208786 |  0.00298058947158662 |    -1.64139656894231 |    0.100729978144963 | FALSE    |
  | lignin                                  |   -0.0182915031497018 |  0.00480018568899028 |    -3.81058240968788 | 0.000139031928679657 | TRUE     |
  | chl                                     |    0.0396960450237623 |  0.00431567167981401 |     9.19811514148199 | 3.97118100456321e-20 | TRUE     |
  | pct_imp_20m:pct_imp_100m                |    -0.315970796263861 |   0.0634093720560308 |    -4.98302989003988 | 6.30898231383201e-07 | TRUE     |
  | st_post no pow:poly(cor_max2005, 4)1    |       3.9954591180993 |    0.411725577505908 |     9.70418000820454 | 3.21960354767681e-22 | TRUE     |
  | st_post w pow:poly(cor_max2005, 4)1     |    -0.928262811150266 |    0.578061003508887 |    -1.60582154048728 |    0.108328043560788 | FALSE    |
  | st_post no pow:poly(cor_max2005, 4)2    |    -0.985828821704461 |     0.37949658127443 |    -2.59772780664806 |  0.00939078215033575 | TRUE     |
  | st_post w pow:poly(cor_max2005, 4)2     |      1.08455563120346 |    0.527590745941913 |      2.0556759942163 |   0.0398259955751819 | FALSE    |
  | st_post no pow:poly(cor_max2005, 4)3    |     0.135126128508626 |    0.432198400786499 |    0.312648376909143 |    0.754550899819995 | FALSE    |
  | st_post w pow:poly(cor_max2005, 4)3     |   -0.0310945533777591 |    0.606073102622601 |  -0.0513049551996396 |    0.959083003742315 | FALSE    |
  | st_post no pow:poly(cor_max2005, 4)4    |   -0.0901398041322806 |    0.368418294085341 |   -0.244667014584787 |    0.806716642037495 | FALSE    |
  | st_post w pow:poly(cor_max2005, 4)4     |     -0.30627417661039 |    0.634948498761919 |   -0.482360659498513 |    0.629554750609846 | FALSE    |
  | st_post no pow:tpi_5ft                  |    0.0261733068081751 |  0.00979442278567366 |     2.67226638883293 |  0.00753985161615142 | TRUE     |
  | st_post w pow:tpi_5ft                   |   0.00700404345520524 |   0.0142294683213078 |    0.492221023094525 |    0.622568209036119 | FALSE    |
  | st_post no pow:tpi_200ft                |   0.00153333134953271 | 0.000654884203227906 |     2.34137782217828 |   0.0192219394398874 | FALSE    |
  | st_post w pow:tpi_200ft                 | -0.000882979780832367 |   0.0010410195218011 |   -0.848187533798306 |    0.396343129861569 | FALSE    |
  | st_post no pow:aspect_trans_200ft       |  0.000955914797735086 |  0.00311674601400407 |    0.306702821930308 |    0.759072598501376 | FALSE    |
  | st_post w pow:aspect_trans_200ft        |  -0.00511632515635838 |  0.00434681658984677 |    -1.17702807344322 |    0.239197536460723 | FALSE    |
  | st_post no pow:elev                     | -0.000647858043766331 | 0.000180319107811569 |     -3.5928418880784 | 0.000327832748352623 | TRUE     |
  | st_post w pow:elev                      | -0.000327654550737512 | 0.000266794708301765 |    -1.22811487837648 |    0.219417502187133 | FALSE    |
  | st_post no pow:mean_height_wn20m        |   0.00250652113737682 |  0.00132194666818051 |     1.89608340314267 |   0.0579626221634666 | FALSE    |
  | st_post w pow:mean_height_wn20m         |   0.00462996222194272 |  0.00213333469268442 |     2.17029340863376 |    0.029995707357363 | FALSE    |
  | st_post no pow:pct_imp_20m              |    0.0222352818179859 |   0.0343629675919503 |    0.647071058647293 |    0.517592972006889 | FALSE    |
  | st_post w pow:pct_imp_20m               | -0.000151134535492928 |   0.0547831827213266 | -0.00275877610583024 |    0.997798843928372 | FALSE    |
  | st_post no pow:pct_imp_100m             |    -0.171290256132809 |    0.029369207778588 |    -5.83230768171043 | 5.54613618180382e-09 | TRUE     |
  | st_post w pow:pct_imp_100m              |    -0.173248173985867 |   0.0485672427230388 |    -3.56718158726527 | 0.000361637981877286 | TRUE     |
  | st_post no pow:TotPhen                  |   -0.0164887349933291 |  0.00449004821302941 |    -3.67228461945719 |  0.00024098339393596 | TRUE     |
  | st_post w pow:TotPhen                   |   -0.0122988016414669 |  0.00675804186408966 |    -1.81987650991322 |   0.0687919303920148 | FALSE    |
  | st_post no pow:N                        |    0.0270225142095382 |  0.00444647855969483 |     6.07728427040763 | 1.24325014486152e-09 | TRUE     |
  | st_post w pow:N                         |    0.0137867304617802 |  0.00625894935062153 |     2.20272280369407 |   0.0276250296738366 | FALSE    |
  | st_post no pow:Sugar                    |    0.0125392529044446 |  0.00497143666087809 |      2.5222594110713 |   0.0116676394359552 | FALSE    |
  | st_post w pow:Sugar                     |  -0.00168399964728729 |   0.0073960357404686 |   -0.227689495613578 |      0.8198898384017 | FALSE    |
  | st_post no pow:LMA                      |   -0.0017989982820019 |  0.00326784648636587 |   -0.550514930706717 |     0.58197204851521 | FALSE    |
  | st_post w pow:LMA                       |   0.00214589035200884 |  0.00480880566365644 |     0.44624185340382 |    0.655427117936699 | FALSE    |
  | st_post no pow:lignin                   | -0.000251557470423805 |  0.00527414050867043 |  -0.0476963914803288 |     0.96195865999671 | FALSE    |
  | st_post w pow:lignin                    |   0.00485789025150235 |  0.00824054703127175 |    0.589510651788931 |     0.55552506071202 | FALSE    |
  | st_post no pow:chl                      |   -0.0261950838811147 |  0.00476033288098782 |    -5.50278405649627 | 3.78173524423853e-08 | TRUE     |
  | st_post w pow:chl                       |   -0.0243493247032225 |  0.00727289243630377 |    -3.34795611463729 |  0.00081551788467515 | TRUE     |
  | st_post no pow:pct_imp_20m:pct_imp_100m |     0.119128383538916 |   0.0690749280969244 |     1.72462551639226 |   0.0846095805441205 | FALSE    |
  | st_post w pow:pct_imp_20m:pct_imp_100m  |     0.155048109683856 |    0.101991817538991 |     1.52020145757851 |    0.128475287704313 | FALSE    |
#+END_SRC
...
lm(formula = growth.rate ~ Genus + poly(cor_max2005, 4) + tpi_5ft + 
    ...
    pct_imp_20m * pct_imp_100m + TotPhen + N + Sugar + LMA + 
    lignin + chl, data = dc, subset = dc$st_po == "st w pow")

Residuals:
     Min       1Q   Median       3Q      Max 
-0.52591 -0.07294 -0.00639  0.06425  0.68176 

Coefficients:
                           Estimate Std. Error t value Pr(>|t|)    
(Intercept)              -2.072e-01  7.176e-02  -2.888 0.003918 ** 
GenusBetula               2.375e-02  5.416e-02   0.438 0.661120    
GenusCarya                9.407e-02  4.573e-02   2.057 0.039806 *  
GenusCatalpa              1.162e-01  3.993e-02   2.910 0.003646 ** 
GenusCeltis               2.390e-03  2.188e-02   0.109 0.913041    
GenusFraxinus             5.573e-02  8.065e-03   6.910 6.24e-12 ***
GenusGinkgo               7.029e-03  3.460e-02   0.203 0.839057    
GenusGleditsia            1.161e-01  9.978e-03  11.632  < 2e-16 ***
GenusGymnocladus         -9.625e-03  1.202e-01  -0.080 0.936201    
GenusJuglans              5.169e-02  3.008e-02   1.718 0.085842 .  
GenusPicea                1.495e-01  3.008e-02   4.971 7.15e-07 ***
GenusPinus                1.678e-01  4.613e-02   3.637 0.000281 ***
GenusPlatanus             2.133e-01  5.049e-02   4.224 2.49e-05 ***
GenusPopulus              4.117e-02  6.312e-02   0.652 0.514241    
GenusQuercus              3.983e-03  1.446e-02   0.276 0.782913    
GenusRobinia              9.762e-02  4.093e-02   2.385 0.017148 *  
GenusThuja               -2.719e-02  7.021e-02  -0.387 0.698591    
GenusTilia                1.529e-01  1.184e-02  12.913  < 2e-16 ***
GenusUlmus                8.489e-02  2.009e-02   4.225 2.48e-05 ***
poly(cor_max2005, 4)1    -1.881e+01  4.795e-01 -39.219  < 2e-16 ***
poly(cor_max2005, 4)2     5.008e+00  4.764e-01  10.512  < 2e-16 ***
poly(cor_max2005, 4)3    -1.524e+00  5.851e-01  -2.605 0.009247 ** 
poly(cor_max2005, 4)4     6.052e-01  6.221e-01   0.973 0.330786    
tpi_5ft                  -2.205e-02  1.129e-02  -1.953 0.050978 .  
tpi_200ft                -3.269e-03  8.988e-04  -3.636 0.000283 ***
aspect_trans_200ft       -9.647e-03  3.328e-03  -2.898 0.003786 ** 
elev                     -4.112e-05  2.084e-04  -0.197 0.843590    
mean_height_wn20m         2.667e-02  1.873e-03  14.237  < 2e-16 ***
pct_imp_20m               5.970e-02  4.582e-02   1.303 0.192739    
pct_imp_100m             -2.240e-02  4.271e-02  -0.525 0.599941    
TotPhen                  -8.809e-03  7.115e-03  -1.238 0.215791    
N                        -4.954e-02  4.892e-03 -10.126  < 2e-16 ***
Sugar                    -2.571e-02  6.339e-03  -4.056 5.17e-05 ***
LMA                      -6.307e-03  4.030e-03  -1.565 0.117677    
lignin                   -1.466e-02  7.537e-03  -1.945 0.051878 .  
chl                       2.094e-02  6.486e-03   3.229 0.001261 ** 
pct_imp_20m:pct_imp_100m -1.743e-01  8.132e-02  -2.143 0.032182 *  
---
codes:  0 ‘***’ 0.001 ‘**’ 0.01 ‘*’ 0.05 ‘.’ 0.1 ‘ ’ 1

Residual standard error: 0.1198 on 2318 degrees of freedom
Multiple R-squared:  0.5192,	Adjusted R-squared:  0.5117 
F-statistic: 69.53 on 36 and 2318 DF,  p-value: < 2.2e-16
#+end_example
...
lm(formula = growth.rate ~ Genus + poly(cor_max2005, 4) + tpi_5ft + 
    tpi_200ft + aspect_trans_200ft + elev + mean_height_wn20m + 
    pct_imp_20m * pct_imp_100m + TotPhen + N + Sugar + LMA + 
    lignin + chl, data = dc, subset = dc$st_po == "st no pow")

Residuals:
     Min       1Q   Median       3Q      Max 
-0.42186 -0.06699 -0.00319  0.06196  0.68274 

Coefficients:
                           Estimate Std. Error t value Pr(>|t|)    
(Intercept)              -2.378e-02  5.431e-02  -0.438  0.66149    
GenusAcer                -9.835e-02  5.051e-02  -1.947  0.05155 .  
GenusBetula              -4.836e-02  5.376e-02  -0.900  0.36835    
GenusCarya               -4.984e-02  5.328e-02  -0.935  0.34961    
GenusCatalpa              2.700e-02  5.548e-02   0.487  0.62656    
GenusCeltis              -9.963e-02  5.101e-02  -1.953  0.05084 .  
GenusFraxinus            -3.628e-02  5.050e-02  -0.718  0.47253    
GenusGinkgo               2.962e-02  5.332e-02   0.555  0.57860    
GenusGleditsia            3.726e-03  5.053e-02   0.074  0.94121    
GenusGymnocladus          7.805e-02  9.428e-02   0.828  0.40776    
GenusJuglans             -2.887e-02  5.202e-02  -0.555  0.57894    
GenusPicea                5.094e-02  5.183e-02   0.983  0.32577    
GenusPinus                1.032e-01  5.208e-02   1.982  0.04745 *  
GenusPlatanus             1.277e-01  6.604e-02   1.934  0.05312 .  
GenusPopulus             -3.734e-02  5.357e-02  -0.697  0.48587    
GenusQuercus             -9.631e-02  5.080e-02  -1.896  0.05800 .  
GenusRobinia              3.286e-02  5.272e-02   0.623  0.53310    
GenusSalix               -3.734e-02  7.561e-02  -0.494  0.62145    
GenusThuja                2.184e-02  5.587e-02   0.391  0.69591    
GenusTilia                4.825e-02  5.059e-02   0.954  0.34027    
GenusUlmus                6.819e-02  5.101e-02   1.337  0.18129    
poly(cor_max2005, 4)1    -1.397e+01  2.154e-01 -64.857  < 2e-16 ***
poly(cor_max2005, 4)2     2.841e+00  2.599e-01  10.932  < 2e-16 ***
poly(cor_max2005, 4)3    -1.401e+00  3.492e-01  -4.013 6.02e-05 ***
poly(cor_max2005, 4)4     7.505e-01  2.969e-01   2.528  0.01150 *  
tpi_5ft                  -4.231e-03  4.051e-03  -1.044  0.29632    
tpi_200ft                -9.670e-04  3.438e-04  -2.813  0.00491 ** 
aspect_trans_200ft       -3.599e-03  1.250e-03  -2.879  0.00400 ** 
elev                     -4.150e-04  4.998e-05  -8.303  < 2e-16 ***
mean_height_wn20m         2.436e-02  6.773e-04  35.969  < 2e-16 ***
pct_imp_20m               7.507e-02  1.428e-02   5.256 1.49e-07 ***
pct_imp_100m             -2.269e-02  1.522e-02  -1.491  0.13607    
TotPhen                  -1.085e-02  2.374e-03  -4.571 4.88e-06 ***
N                        -3.437e-02  1.820e-03 -18.885  < 2e-16 ***
Sugar                    -1.550e-02  2.140e-03  -7.242 4.64e-13 ***
LMA                      -7.208e-03  1.404e-03  -5.134 2.87e-07 ***
lignin                   -1.569e-02  2.364e-03  -6.638 3.28e-11 ***
chl                       1.369e-02  2.203e-03   6.214 5.30e-10 ***
pct_imp_20m:pct_imp_100m -2.019e-01  2.649e-02  -7.624 2.60e-14 ***
---
codes:  0 ‘***’ 0.001 ‘**’ 0.01 ‘*’ 0.05 ‘.’ 0.1 ‘ ’ 1

Residual standard error: 0.1126 on 15176 degrees of freedom
Multiple R-squared:  0.4473,	Adjusted R-squared:  0.4459 
F-statistic: 323.2 on 38 and 15176 DF,  p-value: < 2.2e-16
#+end_example
...
Residuals:
     Min       1Q   Median       3Q      Max 
-0.51297 -0.08899 -0.00886  0.07595  0.85752 

Coefficients:
                           Estimate Std. Error t value Pr(>|t|)    
(Intercept)              -1.152e-01  7.347e-02  -1.568 0.116873    
GenusAcer                -1.102e-01  3.032e-02  -3.634 0.000283 ***
GenusBetula              -1.143e-01  3.166e-02  -3.611 0.000309 ***
GenusCarya               -5.622e-02  4.052e-02  -1.388 0.165360    
GenusCatalpa             -5.159e-03  3.757e-02  -0.137 0.890790    
GenusCeltis              -1.049e-01  3.237e-02  -3.240 0.001208 ** 
GenusFraxinus            -1.109e-01  3.107e-02  -3.570 0.000361 ***
GenusGinkgo               4.911e-02  6.138e-02   0.800 0.423668    
GenusGleditsia           -6.258e-02  3.065e-02  -2.042 0.041233 *  
GenusGymnocladus          7.261e-02  7.705e-02   0.942 0.346078    
GenusJuglans             -2.293e-02  3.260e-02  -0.703 0.481804    
GenusPicea               -1.090e-02  3.075e-02  -0.354 0.723030    
GenusPinus                7.515e-02  3.148e-02   2.387 0.017038 *  
GenusPlatanus             4.555e-02  5.401e-02   0.843 0.399073    
GenusPopulus             -8.663e-02  3.443e-02  -2.516 0.011912 *  
GenusQuercus             -1.393e-01  3.055e-02  -4.560 5.29e-06 ***
GenusRobinia              5.451e-03  3.527e-02   0.155 0.877175    
GenusThuja               -6.884e-02  3.315e-02  -2.077 0.037879 *  
GenusTilia               -3.826e-02  3.398e-02  -1.126 0.260281    
GenusUlmus               -6.131e-02  3.230e-02  -1.898 0.057803 .  
poly(cor_max2005, 4)1    -1.817e+01  4.208e-01 -43.169  < 2e-16 ***
poly(cor_max2005, 4)2     3.731e+00  3.205e-01  11.642  < 2e-16 ***
poly(cor_max2005, 4)3    -1.492e+00  2.751e-01  -5.423 6.23e-08 ***
poly(cor_max2005, 4)4     9.601e-01  2.306e-01   4.164 3.20e-05 ***
tpi_5ft                  -3.180e-02  1.050e-02  -3.030 0.002463 ** 
tpi_200ft                -2.676e-03  6.527e-04  -4.100 4.23e-05 ***
aspect_trans_200ft       -4.596e-03  3.383e-03  -1.358 0.174399    
elev                      2.481e-04  2.079e-04   1.193 0.232852    
mean_height_wn20m         2.235e-02  1.333e-03  16.770  < 2e-16 ***
pct_imp_20m               5.149e-02  3.694e-02   1.394 0.163424    
pct_imp_100m              1.365e-01  2.982e-02   4.577 4.88e-06 ***
TotPhen                  -1.260e-02  5.522e-03  -2.281 0.022577 *  
N                        -5.389e-02  4.979e-03 -10.825  < 2e-16 ***
Sugar                    -2.485e-02  5.660e-03  -4.390 1.16e-05 ***
LMA                      -7.831e-05  3.710e-03  -0.021 0.983161    
lignin                   -2.571e-02  5.890e-03  -4.365 1.31e-05 ***
chl                       3.152e-02  5.474e-03   5.759 9.17e-09 ***
pct_imp_20m:pct_imp_100m -2.962e-01  7.587e-02  -3.904 9.65e-05 ***
---
codes:  0 ‘***’ 0.001 ‘**’ 0.01 ‘*’ 0.05 ‘.’ 0.1 ‘ ’ 1

Residual standard error: 0.1417 on 3636 degrees of freedom
Multiple R-squared:  0.4758,	Adjusted R-squared:  0.4705 
F-statistic:  89.2 on 37 and 3636 DF,  p-value: < 2.2e-16
#+end_example
...
#+begin_src R
        nd <- expand.grid(pct_imp_20m = seq(0, 1, .1),
                         pct_imp_100m = seq(0, 1, .1))

    mediand <- dc %>% summarize_all(median) %>%
             select(-pct_imp_20m, -pct_imp_100m)
...
Residuals:
     Min       1Q   Median       3Q      Max 
-0.43175 -0.07116 -0.00247  0.06569  0.62442 

Coefficients:
                           Estimate Std. Error t value Pr(>|t|)    
(Intercept)               1.332e-01  4.215e-02   3.161  0.00158 ** 
st_post no pow           -3.822e-02  6.155e-03  -6.209 5.97e-10 ***
st_post w pow             9.096e-03  7.946e-03   1.145  0.25240    
poly(cor_max2005, 4)1    -1.541e+01  9.261e-01 -16.635  < 2e-16 ***
poly(cor_max2005, 4)2     2.338e+00  1.700e+00   1.376  0.16895    
poly(cor_max2005, 4)3    -6.077e-01  2.002e+00  -0.304  0.76149    
poly(cor_max2005, 4)4     1.323e+00  1.206e+00   1.097  0.27267    
tpi_5ft                  -8.678e-04  8.429e-03  -0.103  0.91801    
tpi_200ft                -3.546e-04  7.510e-04  -0.472  0.63685    
aspect_trans_200ft       -1.363e-03  2.703e-03  -0.504  0.61413    
elev                     -7.533e-04  1.115e-04  -6.755 1.67e-11 ***
mean_height_wn20m         2.397e-02  1.407e-03  17.036  < 2e-16 ***
pct_imp_20m               3.017e-02  2.938e-02   1.027  0.30452    
pct_imp_100m             -2.036e-02  2.698e-02  -0.755  0.45047    
TotPhen                   3.786e-02  5.636e-03   6.717 2.16e-11 ***
N                        -2.414e-02  4.629e-03  -5.215 1.94e-07 ***
Sugar                    -4.236e-02  5.414e-03  -7.824 6.76e-15 ***
LMA                       3.075e-03  3.076e-03   1.000  0.31756    
lignin                    8.477e-03  5.437e-03   1.559  0.11907    
chl                       4.466e-03  5.239e-03   0.852  0.39404    
pct_imp_20m:pct_imp_100m -2.167e-01  4.878e-02  -4.443 9.15e-06 ***
---
codes:  0 ‘***’ 0.001 ‘**’ 0.01 ‘*’ 0.05 ‘.’ 0.1 ‘ ’ 1

Residual standard error: 0.1093 on 3418 degrees of freedom
Multiple R-squared:  0.3987,	Adjusted R-squared:  0.3952 
F-statistic: 113.3 on 20 and 3418 DF,  p-value: < 2.2e-16
#+end_example
...
Residuals:
     Min       1Q   Median       3Q      Max 
-0.34205 -0.05540 -0.00426  0.04855  0.65758 

Coefficients:
                           Estimate Std. Error t value Pr(>|t|)    
(Intercept)               6.045e-02  2.670e-02   2.264 0.023632 *  
st_post no pow           -2.727e-02  5.945e-03  -4.586 4.60e-06 ***
st_post w pow            -8.241e-03  6.661e-03  -1.237 0.216094    
poly(cor_max2005, 4)1    -1.565e+01  3.468e-01 -45.133  < 2e-16 ***
poly(cor_max2005, 4)2     2.919e+00  5.192e-01   5.622 1.98e-08 ***
poly(cor_max2005, 4)3     1.829e-01  6.199e-01   0.295 0.767931    
poly(cor_max2005, 4)4     2.263e+00  5.815e-01   3.892 0.000100 ***
tpi_5ft                  -1.203e-03  5.446e-03  -0.221 0.825197    
tpi_200ft                -9.176e-04  4.413e-04  -2.079 0.037645 *  
aspect_trans_200ft       -1.208e-03  1.629e-03  -0.742 0.458318    
elev                     -6.103e-04  6.819e-05  -8.950  < 2e-16 ***
mean_height_wn20m         2.204e-02  9.490e-04  23.219  < 2e-16 ***
pct_imp_20m               5.590e-02  1.923e-02   2.907 0.003665 ** 
pct_imp_100m             -4.262e-02  1.886e-02  -2.260 0.023878 *  
TotPhen                   1.685e-02  3.661e-03   4.602 4.28e-06 ***
N                        -2.111e-02  2.613e-03  -8.081 7.70e-16 ***
Sugar                    -6.107e-03  3.445e-03  -1.773 0.076297 .  
LMA                      -6.147e-03  1.931e-03  -3.183 0.001463 ** 
lignin                   -1.363e-02  3.869e-03  -3.524 0.000428 ***
chl                       3.093e-02  3.111e-03   9.944  < 2e-16 ***
pct_imp_20m:pct_imp_100m -1.455e-01  3.406e-02  -4.271 1.98e-05 ***
---
codes:  0 ‘***’ 0.001 ‘**’ 0.01 ‘*’ 0.05 ‘.’ 0.1 ‘ ’ 1

Residual standard error: 0.09299 on 5915 degrees of freedom
Multiple R-squared:  0.4105,	Adjusted R-squared:  0.4085 
F-statistic: 205.9 on 20 and 5915 DF,  p-value: < 2.2e-16
#+end_example
...
Residuals:
     Min       1Q   Median       3Q      Max 
-0.43739 -0.07723 -0.00747  0.07191  0.70022 

Coefficients:
                           Estimate Std. Error t value Pr(>|t|)    
(Intercept)              -1.669e-01  3.641e-02  -4.584 4.64e-06 ***
st_post no pow           -7.417e-02  5.165e-03 -14.359  < 2e-16 ***
st_post w pow            -4.589e-02  6.828e-03  -6.721 1.96e-11 ***
poly(cor_max2005, 4)1    -1.385e+01  3.126e-01 -44.295  < 2e-16 ***
poly(cor_max2005, 4)2     2.330e+00  3.238e-01   7.195 6.92e-13 ***
poly(cor_max2005, 4)3    -3.134e+00  4.517e-01  -6.939 4.33e-12 ***
poly(cor_max2005, 4)4     6.754e-01  4.367e-01   1.546  0.12204    
tpi_5ft                  -1.724e-02  7.060e-03  -2.442  0.01464 *  
tpi_200ft                -4.893e-04  5.996e-04  -0.816  0.41446    
aspect_trans_200ft       -5.917e-03  2.161e-03  -2.738  0.00619 ** 
elev                     -1.570e-05  9.708e-05  -0.162  0.87154    
mean_height_wn20m         2.558e-02  1.090e-03  23.469  < 2e-16 ***
pct_imp_20m               4.524e-02  2.745e-02   1.648  0.09940 .  
pct_imp_100m              7.320e-03  2.797e-02   0.262  0.79358    
TotPhen                  -3.735e-02  3.726e-03 -10.025  < 2e-16 ***
N                        -4.472e-02  3.040e-03 -14.710  < 2e-16 ***
Sugar                    -1.089e-02  3.589e-03  -3.035  0.00242 ** 
LMA                      -4.878e-03  2.456e-03  -1.986  0.04708 *  
lignin                   -3.511e-02  3.955e-03  -8.877  < 2e-16 ***
chl                       1.580e-02  3.726e-03   4.240 2.26e-05 ***
pct_imp_20m:pct_imp_100m -1.216e-01  5.748e-02  -2.116  0.03437 *  
---
codes:  0 ‘***’ 0.001 ‘**’ 0.01 ‘*’ 0.05 ‘.’ 0.1 ‘ ’ 1

Residual standard error: 0.1298 on 6742 degrees of freedom
Multiple R-squared:  0.3215,	Adjusted R-squared:  0.3195 
F-statistic: 159.7 on 20 and 6742 DF,  p-value: < 2.2e-16
#+end_example
...
Residuals:
     Min       1Q   Median       3Q      Max 
-0.34208 -0.07181 -0.01253  0.05344  0.73044 

Coefficients:
                           Estimate Std. Error t value Pr(>|t|)    
(Intercept)              -1.238e-01  9.055e-02  -1.368  0.17173    
st_post no pow           -4.230e-02  8.891e-03  -4.758 2.25e-06 ***
st_post w pow            -2.556e-02  1.372e-02  -1.863  0.06279 .  
poly(cor_max2005, 4)1    -1.952e+01  9.047e-01 -21.579  < 2e-16 ***
poly(cor_max2005, 4)2     4.057e+00  6.819e-01   5.950 3.73e-09 ***
poly(cor_max2005, 4)3    -1.572e+00  5.171e-01  -3.040  0.00243 ** 
poly(cor_max2005, 4)4    -1.801e-02  5.663e-01  -0.032  0.97464    
tpi_5ft                   2.913e-02  1.521e-02   1.915  0.05575 .  
tpi_200ft                -3.840e-03  8.394e-04  -4.574 5.38e-06 ***
aspect_trans_200ft       -2.130e-02  5.052e-03  -4.216 2.71e-05 ***
elev                     -2.613e-05  2.896e-04  -0.090  0.92812    
mean_height_wn20m         2.196e-02  2.347e-03   9.355  < 2e-16 ***
pct_imp_20m              -3.199e-02  6.525e-02  -0.490  0.62403    
pct_imp_100m              5.136e-02  5.234e-02   0.981  0.32668    
TotPhen                  -4.228e-03  1.068e-02  -0.396  0.69234    
N                        -2.798e-02  9.408e-03  -2.974  0.00301 ** 
Sugar                    -1.867e-02  8.762e-03  -2.131  0.03334 *  
LMA                      -3.596e-03  6.091e-03  -0.590  0.55511    
lignin                   -1.087e-02  1.135e-02  -0.958  0.33845    
chl                      -5.622e-03  9.294e-03  -0.605  0.54541    
pct_imp_20m:pct_imp_100m  1.126e-01  1.651e-01   0.682  0.49536    
---
codes:  0 ‘***’ 0.001 ‘**’ 0.01 ‘*’ 0.05 ‘.’ 0.1 ‘ ’ 1

Residual standard error: 0.1159 on 981 degrees of freedom
Multiple R-squared:  0.3852,	Adjusted R-squared:  0.3726 
F-statistic: 30.73 on 20 and 981 DF,  p-value: < 2.2e-16
#+end_example
...
Residuals:
     Min       1Q   Median       3Q      Max 
-0.32700 -0.06445 -0.00190  0.06374  0.46853 

Coefficients:
                           Estimate Std. Error t value Pr(>|t|)    
(Intercept)               9.441e-02  5.856e-02   1.612  0.10712    
st_post no pow           -2.729e-02  1.313e-02  -2.078  0.03784 *  
st_post w pow             9.736e-03  1.583e-02   0.615  0.53867    
poly(cor_max2005, 4)1    -1.768e+01  6.708e-01 -26.356  < 2e-16 ***
poly(cor_max2005, 4)2     1.165e+00  9.622e-01   1.211  0.22618    
poly(cor_max2005, 4)3    -3.810e+00  1.391e+00  -2.739  0.00623 ** 
poly(cor_max2005, 4)4    -1.749e+00  1.120e+00  -1.562  0.11847    
tpi_5ft                  -1.044e-02  1.216e-02  -0.859  0.39075    
tpi_200ft                -7.152e-05  9.459e-04  -0.076  0.93974    
aspect_trans_200ft       -1.101e-02  3.702e-03  -2.973  0.00299 ** 
elev                     -4.668e-04  1.480e-04  -3.154  0.00164 ** 
mean_height_wn20m         2.009e-02  2.003e-03  10.028  < 2e-16 ***
pct_imp_20m               1.304e-01  4.102e-02   3.178  0.00151 ** 
pct_imp_100m              3.048e-02  4.791e-02   0.636  0.52478    
TotPhen                  -5.848e-03  7.554e-03  -0.774  0.43892    
N                        -2.688e-02  4.713e-03  -5.704 1.40e-08 ***
Sugar                    -8.951e-03  5.122e-03  -1.748  0.08074 .  
LMA                      -1.259e-02  4.471e-03  -2.816  0.00493 ** 
lignin                   -5.963e-03  5.878e-03  -1.015  0.31050    
chl                      -2.518e-03  6.326e-03  -0.398  0.69061    
pct_imp_20m:pct_imp_100m -3.155e-01  8.008e-02  -3.940 8.53e-05 ***
---
codes:  0 ‘***’ 0.001 ‘**’ 0.01 ‘*’ 0.05 ‘.’ 0.1 ‘ ’ 1

Residual standard error: 0.1047 on 1502 degrees of freedom
Multiple R-squared:  0.4963,	Adjusted R-squared:  0.4896 
F-statistic:    74 on 20 and 1502 DF,  p-value: < 2.2e-16
#+end_example
...
Residuals:
     Min       1Q   Median       3Q      Max 
-0.57069 -0.11988 -0.01193  0.08427  0.83183 

Coefficients:
                           Estimate Std. Error t value Pr(>|t|)    
(Intercept)               4.026e-01  3.172e-01   1.269  0.20560    
st_post no pow           -1.398e-01  3.284e-02  -4.258 2.95e-05 ***
st_post w pow            -1.235e-01  8.396e-02  -1.471  0.14264    
poly(cor_max2005, 4)1    -2.101e+01  2.520e+00  -8.337 5.78e-15 ***
poly(cor_max2005, 4)2     2.767e+00  4.667e+00   0.593  0.55375    
poly(cor_max2005, 4)3    -3.778e+00  6.533e+00  -0.578  0.56361    
poly(cor_max2005, 4)4    -2.741e+00  6.112e+00  -0.449  0.65419    
tpi_5ft                   8.626e-02  7.599e-02   1.135  0.25745    
tpi_200ft                -9.687e-03  4.006e-03  -2.418  0.01635 *  
aspect_trans_200ft       -1.914e-02  1.859e-02  -1.029  0.30435    
elev                     -1.208e-03  9.617e-04  -1.256  0.21037    
mean_height_wn20m         2.285e-02  6.874e-03   3.324  0.00103 ** 
pct_imp_20m               3.384e-01  1.961e-01   1.726  0.08571 .  
pct_imp_100m              1.720e-02  2.309e-01   0.074  0.94069    
TotPhen                  -6.680e-02  3.111e-02  -2.147  0.03276 *  
N                        -7.004e-02  2.562e-02  -2.734  0.00672 ** 
Sugar                    -4.501e-02  3.052e-02  -1.475  0.14156    
LMA                       5.240e-03  2.117e-02   0.248  0.80469    
lignin                   -2.243e-02  3.181e-02  -0.705  0.48137    
chl                      -2.405e-02  3.244e-02  -0.741  0.45914    
pct_imp_20m:pct_imp_100m -8.093e-01  4.830e-01  -1.675  0.09514 .  
---
codes:  0 ‘***’ 0.001 ‘**’ 0.01 ‘*’ 0.05 ‘.’ 0.1 ‘ ’ 1

Residual standard error: 0.2002 on 242 degrees of freedom
Multiple R-squared:  0.4312,	Adjusted R-squared:  0.3842 
F-statistic: 9.174 on 20 and 242 DF,  p-value: < 2.2e-16
#+end_example
...
Residuals:
     Min       1Q   Median       3Q      Max 
-0.41801 -0.10013 -0.00354  0.10206  0.72186 

Coefficients:
                           Estimate Std. Error t value Pr(>|t|)    
(Intercept)               1.306e-02  2.116e-01   0.062 0.950807    
st_post no pow           -5.064e-02  2.070e-02  -2.446 0.014878 *  
st_post w pow            -3.073e-03  3.939e-02  -0.078 0.937866    
poly(cor_max2005, 4)1    -1.615e+01  1.625e+00  -9.937  < 2e-16 ***
poly(cor_max2005, 4)2     7.042e+00  2.539e+00   2.774 0.005801 ** 
poly(cor_max2005, 4)3     5.430e+00  3.741e+00   1.452 0.147415    
poly(cor_max2005, 4)4     3.511e+00  2.737e+00   1.283 0.200284    
tpi_5ft                  -7.716e-02  5.003e-02  -1.542 0.123847    
tpi_200ft                -5.231e-03  2.370e-03  -2.208 0.027832 *  
aspect_trans_200ft        2.122e-03  1.113e-02   0.191 0.848862    
elev                     -3.910e-04  6.327e-04  -0.618 0.536940    
mean_height_wn20m         2.357e-02  4.517e-03   5.218 2.92e-07 ***
pct_imp_20m               7.655e-02  1.315e-01   0.582 0.560904    
pct_imp_100m              1.102e-01  1.370e-01   0.805 0.421332    
TotPhen                  -4.254e-03  1.842e-02  -0.231 0.817422    
N                        -6.559e-02  1.403e-02  -4.675 4.02e-06 ***
Sugar                    -1.496e-02  1.798e-02  -0.832 0.405742    
LMA                      -9.042e-04  1.075e-02  -0.084 0.932998    
lignin                   -2.336e-02  1.742e-02  -1.341 0.180639    
chl                       6.383e-02  1.705e-02   3.743 0.000209 ***
pct_imp_20m:pct_imp_100m -3.735e-01  3.173e-01  -1.177 0.239820    
---
codes:  0 ‘***’ 0.001 ‘**’ 0.01 ‘*’ 0.05 ‘.’ 0.1 ‘ ’ 1

Residual standard error: 0.1547 on 399 degrees of freedom
Multiple R-squared:  0.4563,	Adjusted R-squared:  0.4291 
F-statistic: 16.74 on 20 and 399 DF,  p-value: < 2.2e-16
#+end_example
