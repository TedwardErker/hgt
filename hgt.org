...
| slope  at 1.5 m (5 ft) scale                                   |            1.5 | Digital Elevation Model (DEM)              | citep:raster_Rpackage |
...
| elevation (hundreds of meters)                                 |            1.5 | DEM                                        |                       |
...
citep:roussel_auty_2018.

DESCRIBE LIDAR METRICS USED AND HOW THEY WERE CREATED.
...
I need to be more clear that this is the mean of the maximum heights
in the surrounding 20m
...
improved AIC (2123 lower with 315 more parameters) and a higher
adjusted R^2 (.569 compared to .506).
...
Madison had a significant relationship with growth.  Elevation in the
city ranges from around 250 m to 350 m.  Our model estimated that
trees growing in the highest parts of the city grew about 2.2 cm yr^{-1}
more than trees growing in the lowest parts of the city.  While trees
at higher elevations grew faster than trees at lower elevations,
...
in the southwest aspect by almost .75 cm yr^{-1}, while at the 61 m scale
the effect was nearly opposite.
...
growth rates (all over 20 cm yr^{-1}, though Ginkgo has high
uncertainty).  Other fast growing genera are Ulmus, Tilia, Populus,
Catalpa and Carya (estimated marginal growth rates over 17.5 cm yr^{-1}).
Quercus, Juglans, Celtis and Acer had slow growth (estimated marginal
growth rates less than 12 cm yr^{-1}.
