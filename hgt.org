...
****** TODO NO NEED TO DO, IT'S IN DATA FROM WISCVIEW find ground  I NEED TO FIX THIS!!!!  at present their ground is better tp use.
#+begin_src R
  library(lidR)

  tile <- "lc2t70833f"

  #g <- readLAS("/media/erker/TOWNSEND/LiDAR_2009/BareEarth/LAS/lb2t70833f.LAS")
  #l <- readLAS("/media/erker/TOWNSEND/LiDAR_2009/PointCloud/LAS_Raw_1of2/lc2t70833f.LAS")
    ...
    lapply(tiles, function(tile) {
        ...
        writeLAS(lg, paste0("/media/erker/DATA_ERKER/dd/madison_lidar_2009_heights/LAS_ground/",tile, "_ground.las"))
  })
#+end_src


#+begin_src R
      ln <- lasnormalize(lg, tin())
    chm <- grid_canopy(ln, res = 3, p2r(1))
  writeRaster(chm, "test.tif", overwrite = T)
#+end_src
...
: There were 1 degenerated ground points. Some X Y coordinates were repeated but with different Z coordinates. min Z were retained.
...
#+begin_src R :exports results :results graphics :file figs/correction_nogrowth_40.png :width 1300 :height 800 :bg transparent :res 100
...
#+RESULTS:
[[file:figs/correction_nogrowth_40.png]]
...
#+begin_src R
  ...
  l2017 <- readLAS("/home/erker/hgt_data/madison_lidar_2017_heights/normalized/0777_esri_normalized.las", select = "r")
    ...
    l2009 <- readLAS("/home/erker/hgt_data/madison_lidar_2009_heights/normalized/lc2t81034f_ground_normalized.las", select = "r")
...
#+begin_src R
  ...
  l2017 <- readLAS("/home/erker/hgt_data/madison_lidar_2017_heights/normalized/0824_esri_normalized.las", select = "r")
    ...
    l2009 <- readLAS("/home/erker/hgt_data/madison_lidar_2009_heights/normalized/lc2t71007f_ground_normalized.las", select = "r")
    l2005 <- readLAS("/home/erker/hgt_data/madison_lidar_2005_heights/normalized/tile014_ground_normalized.las", select = "r")
...
#+begin_src R
  ...
  l2017 <- readLAS("/home/erker/hgt_data/madison_lidar_2017_heights/normalized/0917_esri_normalized.las", select = "r")
    ...
    l2009 <- readLAS("/home/erker/hgt_data/madison_lidar_2009_heights/normalized/lc2t70919f_ground_normalized.las", select = "r")
...
#+begin_src R
  ...
  l2017 <- readLAS("/home/erker/hgt_data/madison_lidar_2017_heights/normalized/1019_esri_normalized.las", select = "r")
    ...
    l2009 <- readLAS("/home/erker/hgt_data/madison_lidar_2009_heights/normalized/lc2t70933f_ground_normalized.las", select = "r")
    l2005 <- readLAS("/home/erker/hgt_data/madison_lidar_2005_heights/normalized/tile020_ground_normalized.las", select = "r")
...
#+begin_src R :exports results :results graphics :file figs/ST45429.png :width 1200 :height 300 :res 100 :bg transparent
