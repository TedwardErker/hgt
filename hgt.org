...
#+begin_src R :exports results :results graphics :file figs/growthrate_histogram_w.png :width 1200 :res 150 :bg transparent
  ggplot(dc, aes(x = 100 * growth.rate)) + geom_histogram(binwidth = 2) +
    terk +
...
-0.83462 -0.09955 -0.02014  0.07626  1.10848 

Coefficients:
              Estimate Std. Error t value Pr(>|t|)    
(Intercept)   0.159767   0.001774  90.040  < 2e-16 ***
pct_imp_20m  -0.026797   0.004843  -5.534 3.16e-08 ***
pct_imp_100m -0.058914   0.005802 -10.155  < 2e-16 ***
---
codes:  0 ‘***’ 0.001 ‘**’ 0.01 ‘*’ 0.05 ‘.’ 0.1 ‘ ’ 1

Residual standard error: 0.151 on 41946 degrees of freedom
...
Residuals:
     Min       1Q   Median       3Q      Max 
-0.83390 -0.09980 -0.02001  0.07671  1.14607 

Coefficients:
                          Estimate Std. Error t value Pr(>|t|)    
(Intercept)               0.132302   0.003391  39.017  < 2e-16 ***
pct_imp_20m               0.036773   0.008256   4.454 8.46e-06 ***
pct_imp_100m              0.022153   0.010315   2.148   0.0317 *  
pct_imp_20m:pct_imp_100m -0.161802   0.017030  -9.501  < 2e-16 ***
---
codes:  0 ‘***’ 0.001 ‘**’ 0.01 ‘*’ 0.05 ‘.’ 0.1 ‘ ’ 1

Residual standard error: 0.1508 on 41945 degrees of freedom
...
# not very strong evidence for various topography interactions  m00 <- lm(growth.rate ~ st_po + Genus + cor_max2005 + tpi_5ft * tpi_200ft + aspect_trans_5ft + aspect_trans_200ft + elev + mean_height_wn20m + pct_imp_20m + pct_imp_100m + TotPhen + N + Sugar + LMA + lignin + chl, dc)
  ...
  m5 <- lm(growth.rate ~ st_po:poly(cor_max2005,4) + Genus * (st_po + poly(cor_max2005,4) + mean_height_wn20m + pct_imp_20m * pct_imp_100m + TotPhen + N + Sugar + LMA + lignin + chl) + tpi_5ft + aspect_trans_5ft + tpi_200ft + aspect_trans_200ft + elev, dc)
  ...
  m6 <- lm(growth.rate ~ Genus + st_po * st_po:poly(cor_max2005,4) + mean_height_wn20m + pct_imp_20m * pct_imp_100m + TotPhen + N + Sugar + LMA + lignin + chl) + tpi_5ft + aspect_trans_5ft + tpi_200ft + aspect_trans_200ft + elev, dc)
#+end_src
...
Figure [[fig:growthrate_hist]] shows the distribution of growth rates.
...
settled on two models to communicate our results.  The first contains
a fourth order polynomial term for the 2005 height covariate and
interactions between 2005 height 
