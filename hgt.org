...
- AVIRIS flightlines.
* key points
- Genus and height are the strongest predictors of urban tree height growth.
- Trees growing near other trees and buildings grow faster than open
  grown trees, possibly in response to competition for light.
- Percent impervious cover interacts at multiple scales to affect tree
  ...
  being equal.
- Three foliar canopy traits predicted from imaging spectroscopy:
  nitrogen, total phenolics, and chlorophyll were significantly
  related to growth.  Nitrogen and total phenolics had negative
  coefficients and chlorophyll had positive coefficients.
...
trees to provide ecosystem services is seen as a way to make the
environment that most people interact with more pleasant.  These
ecosystem services include habitat for wildlife, stormwater runoff
reduction, air quality improvement, and carbon sequestration cite:roy_etal_2012.
...
factors and therefore the growth of trees.
...
addition to foliar traits, we calculated other covariates
such as percent impervious cover at two scales (within 20m and within
100m), topographic variables, and the mean height of the surroundings
within 20 m of a tree (see table [[tab:covariates]] for all covariates).
...
| Sugar                         | Sugar                                    | AVIRIS-NG                       |                                                                                                                                |
| lignin                        | lignin                                   | AVIRIS-NG                       |                                                                                                                                |
| chlorophyll                   | chlorophyll                              | AVIRIS-NG                       |                                                                                                                                |
| leaf mass per area            | leaf mass per area                       | AVIRIS-NG                       |                                                                                                                                |
| total phenolics               | total phenolics                          | AVIRIS-NG                       |                                                                                                                                |
| nitrogen                      | nitrogen                                 | AVIRIS-NG                       |                                                                                                                                |
...
interactions that made sense given our hypotheses.  We used AIC to
...
inventory.  give species breakdowns too.  The street tree inventories
also provided information on presence of overhead utility lines.  
...
significantly related some of the traits, but they have little
predictive power in our model.  They slightly budge the adjusted R^2
from .54 to .56 for the model with genus.
