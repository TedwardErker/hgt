...
***** compare 2017 to 2016
 ...
 #+begin_src R
 l2016 <- readLAS("/home/erker/hgt_data/madison_tree_inventories/hgt/trees_2016_las/ST14603_102_norm.las")
plot(l2016)

l2017 <- readLAS("/home/erker/hgt_data/madison_tree_inventories/hgt/trees_2017_las/ST14603_0823.las")
plot(l2017)
 #+end_src

 #+RESULTS:

***** what is the bias between years
...
#+begin_src R
  ...
  out <- foreach(i = (1:nrow(uids_df)[1:3), .packages = c("stringr","lidR", "rgeos"), .combine = "rbind") %dopar% {  
