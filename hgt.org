...
- Percent impervious cover interacts at multiple scales to affect tree
  height growth: trees with low impervious cover within 20m and high
  impervious cover within 100m have highest growth rates, all else
  being equal.
...
shapefile(dcs, "test_200msubset.shp")

  vg.rd <-   variogram(resid ~ 1, dcs, cutoff = 2000, width = 40)
...
#+RESULTS:
#+begin_example
  mean_height_wn20m pct_imp_20m pct_imp_100m     TotPhen           N
1          10.42619   0.3577505    0.3472802 -0.01581242 -0.09374776
2          10.42619   0.3577505    0.3472802 -0.01581242 -0.09374776
3          10.42619   0.3577505    0.3472802 -0.01581242 -0.09374776
4          10.42619   0.3577505    0.3472802 -0.01581242 -0.09374776
5          10.42619   0.3577505    0.3472802 -0.01581242 -0.09374776
6          10.42619   0.3577505    0.3472802 -0.01581242 -0.09374776
7          10.42619   0.3577505    0.3472802 -0.01581242 -0.09374776
        Sugar         LMA     lignin           chl    tpi_5ft aspect_trans_5ft
1 -0.02153237 -0.03392554 0.01424437 -0.0006980236 0.09813309        0.9729721
2 -0.02153237 -0.03392554 0.01424437 -0.0006980236 0.09813309        0.9729721
3 -0.02153237 -0.03392554 0.01424437 -0.0006980236 0.09813309        0.9729721
4 -0.02153237 -0.03392554 0.01424437 -0.0006980236 0.09813309        0.9729721
5 -0.02153237 -0.03392554 0.01424437 -0.0006980236 0.09813309        0.9729721
6 -0.02153237 -0.03392554 0.01424437 -0.0006980236 0.09813309        0.9729721
7 -0.02153237 -0.03392554 0.01424437 -0.0006980236 0.09813309        0.9729721
  tpi_200ft aspect_trans_200ft     elev  slope_5ft slope_200ft cor_max2005
1 -0.273056          0.9640593 2.778736 0.06726497  0.02564897          25
2 -0.273056          0.9640593 2.778736 0.06726497  0.02564897          26
3 -0.273056          0.9640593 2.778736 0.06726497  0.02564897          25
4 -0.273056          0.9640593 2.778736 0.06726497  0.02564897          26
5 -0.273056          0.9640593 2.778736 0.06726497  0.02564897          27
6 -0.273056          0.9640593 2.778736 0.06726497  0.02564897          23
7 -0.273056          0.9640593 2.778736 0.06726497  0.02564897          24
     Genus        st_po height2005_2 height2005_3 height2005_4         fit
1 Fraxinus neighborhood          625        15625       390625  0.29818262
2 Fraxinus neighborhood          676        17576       456976 -0.85664342
3 Fraxinus   st no util          625        15625       390625  0.83025594
4 Fraxinus   st no util          676        17576       456976  0.09579786
5 Fraxinus   st no util          729        19683       531441 -0.60989020
6 Fraxinus    st w util          529        12167       279841  0.58909436
7 Fraxinus    st w util          576        13824       331776 -0.44667113
        lwr      upr
1 -4.298915 4.895281
2 -5.957004 4.243717
3 -2.940022 4.600534
...
#+begin_src R :exports results :results graphics :file figs/impervious_street_neighborhood_200mspatialSubset.png :width 1000 :res 120
        ggplot(data = p, aes(x = pct_imp_100m * 100, y = fit, ymin = lwr, ymax = upr, color = pct_imp_20m * 100, group = pct_imp_20m * 100)) + 
...
#+RESULTS:
[[file:figs/impervious_street_neighborhood_200mspatialSubset.png]]
#+begin_src R :exports results :results graphics :file figs/impervious_street_neighborhood_ribbon.png :width 1000 :res 120
          ggplot(data = p, aes(x = pct_imp_100m * 100, y = fit, ymin = lwr, ymax = upr, fill = pct_imp_20m * 100, group = pct_imp_20m * 100)) + 
            geom_ribbon(alpha = .1) +
            geom_line(aes(color = pct_imp_20m * 100), size = .8) +
...
#+begin_src R :exports results :results graphics :file figs/first_model_topo_coef_plots_200mSpatialSubsample.png :width 1150 :height 300 :res 120 :bg transparent
red <- solarized_pal("red")(1)
...
#+RESULTS:
[[file:figs/first_model_topo_coef_plots_200mSpatialSubsample.png]]
...
#+begin_src R :exports results :results graphics :file figs/height_genus_int_stpoNeighborhood_200mSpatialSubsample.png :width 1300 :height 800 :res 120 
...
#+RESULTS:
[[file:figs/height_genus_int_stpoNeighborhood_200mSpatialSubsample.png]]

The negative impact of being a street tree appears to be greater for
Acer than for Fraxinus and Gleditsia.

#+begin_src R :exports results :results graphics :file figs/height_genus_int_stpo_genussub1_SpatialSubset200m.png :width 1300 :res 120
    ggplot(filter(nd, Genus %in% c("Acer", "Fraxinus", "Gleditsia")), aes(x = cor_max2005, y = fit, ymax = upr, ymin = lwr, group = Genus)) +
      geom_ribbon(aes(fill = Genus), alpha = .1) +
      geom_line(aes(color = Genus)) +
      facet_wrap(~st_po, ncol = 3) +
...
#+RESULTS:
[[file:figs/height_genus_int_stpo_genussub1_SpatialSubset200m.png]]

#+begin_src R :exports results :results graphics :file figs/height_genus_int_stpo_genussub2_spatialSUbset200m.png :width 1300 :res 120
    ggplot(filter(nd, Genus %in% c("Acer", "Fraxinus", "Gleditsia")), aes(x = cor_max2005, y = fit, ymax = upr, ymin = lwr, group = st_po)) +
      geom_ribbon(aes(fill = st_po), alpha = .1) +
      geom_line(aes(color = st_po)) +
      facet_wrap(~Genus, ncol = 4) +
...
#+RESULTS:
[[file:figs/height_genus_int_stpo_genussub2_spatialSUbset200m.png]]


#+begin_src R :exports results :results graphics :file figs/height_genus_int_stpolines_SPatialSUbset200m.png :width 1300 :height 800 :res 120 
tpal <- c(brewer.pal(n = 8, name = "Dark2"), brewer.pal(n = 8, name = "Accent")[c(1,6, 7, 5)])
  ggplot(nd, aes(x = cor_max2005, y = fit, ymax = upr, ymin = lwr, group = st_po)) +
    geom_ribbon(aes(fill = st_po), alpha = .1) +
    geom_line(aes(color = st_po)) +
...
#+RESULTS:
[[file:figs/height_genus_int_stpolines_SPatialSUbset200m.png]]

#+begin_src R :exports results :results graphics :file figs/height_genus_int_stpolines_scalesfree_spatialsubset200m.png :width 1300 :height 800 :res 120 
tpal <- c(brewer.pal(n = 8, name = "Dark2"), brewer.pal(n = 8, name = "Accent")[c(1,6, 7, 5)])
  ggplot(nd, aes(x = cor_max2005, y = fit, ymax = upr, ymin = lwr, group = st_po)) +
    geom_ribbon(aes(fill = st_po), alpha = .1) +
    geom_line(aes(color = st_po)) +
...
#+RESULTS:
[[file:figs/height_genus_int_stpolines_scalesfree_spatialsubset200m.png]]
...
#+begin_src R :exports results :results graphics :file figs/mean_height_20m_coefs_spatialSubset200m.png :width 800 :height 475 :bg transparent :res 120
    mtp <- filter(mt, Genus != "Platanus")
...
#+RESULTS:
[[file:figs/mean_height_20m_coefs_spatialSubset200m.png]]
...
#+begin_src R :exports results :results graphics :file figs/traits_coef_comparison_SpatialSubset200m.png :width 1000 :height 800 :bg transparent :res 120
  tpal <- c(brewer.pal(n = 8, name = "Dark2"), brewer.pal(n = 8, name = "Accent")[c(1,6, 7, 5)])
...
#+RESULTS:
[[file:figs/traits_coef_comparison_SpatialSubset200m.png]]

#+begin_src R :exports results :results graphics :file figs/traits_coef_comparison_nogenus_spatialsubset200m.png :width 1000 :height 600 :bg transparent :res 120
    tpal <- c(brewer.pal(n = 8, name = "Dark2"), brewer.pal(n = 8, name = "Accent")[c(1,6, 7, 5)])
...
#+RESULTS:
[[file:figs/traits_coef_comparison_nogenus_spatialsubset200m.png]]
...
stormwater runoff reduction, air quality improvement, and carbon
sequestration citep:roy_etal_2012.  

All these services are a function of growth, either directly such as
carbon sequestration, or indirectly such as stormwater runoff
reduction which is a function of the result of growth: tree size.
Therefore, understanding urban tree growth is essential to estimating
and projecting ecosystem services into the future.  The factors that
contribute to the growth of trees are well understood.  What we do not
understand so well is how the complex urban environment alters these
factors thereby altering the growth of trees.

Urban trees grow differently than their more rural counterparts
because of the challenges they face surviving among urban
...
accommodate powerlines or for aesthetics, many urban trees are
...
Remote sensing technology provides an efficient way to estimate tree
height growth for tens of thousands of trees and derive covariates
such as canopy foliar traits to explain the growth.  Sufficient sample
size is required to detect effect sizes that may be small relative to
the changes induced by the urban environment.  Here we use two
technologies that have only recently become more available, repeat
lidar and imaging spectroscopy.  Lidar uses the reflection of laser
pulses to create 3 dimensional point clouds of objects.  Using
multiple years of lidar data, in conjunction with an innovative height
bias correction, we estimated the heights of trees and their growth
rates.  NASA's Airborne Visible / Infrared Imaging Spectrometer - Next
Generation (AVIRIS-NG) measures the reflectance of light in hundreds
of narrow wavebands from 400 to 2500 nm.  The spectra from the imagery
can be used to predict canopy foliar traits which then in turn we used
to explain height growth.  

In addition to canopy foliar traits, we also included as variables:
topography, landcover, tree height, mean height of a tree's
surroundings and whether or not the tree was a street tree and whether
or not it had overhead utilities. The objectives of our study were to:
...
- Evaluate whether canopy foliar traits estimated from remotely sensed
  imaging spectroscopy can explain tree height growth.
- Evaluate how urban tree height growth is altered by environmental
  ...
  cover, streets, and utility lines).
...
layers to explore the potential for environmental factors and remotely
sense canopy foliar traits to explain urban tree height growth.  Using
...
Shorewood, which is within the city) and two complete inventories of
the trees in Madison's Atwood and Hill Farms neighborhoods to get
taxonomic information of trees.  In September 2015, NASA's Airborne
Visible / Infrared Imaging Spectrometer - Next Generation (AVIRIS-NG)
imaged the majority of Madison.  Using predictive equations developed
following cite:singh_e_2015, we predicted canopy foliar traits:
Nitrogen (% mass), N; leaf mass per area (g/m^2), LMA (g / m^2); lignin
(% mass), chlorophyll (mmol / m^2), and total phenolics (% mass).  We
converted these trait predictions to an index because of imagery
differences between our site and where the model was built.  In
addition to foliar traits, we calculated other covariates such as
percent impervious cover at two scales (within 20m and within 100m),
topographic variables, and the mean height of the surroundings within
20 m of a tree (see table [[tab:covariates]] for all covariates).

#+name: tab:covariates
| Covariate                                                            | Source                           |
|----------------------------------------------------------------------+----------------------------------|
| Bias corrected height in 2005 (m)                                    | lidar                            |
| Mean Height within 20 m (m)                                          | lidar                            |
| Genus                                                                | tree inventories                 |
| tree type: neighborhood or street with or without overhead utilities | tree inventories                 |
| slope  at 1.5 m (5 ft) scale                                         | Digital Elevation Model (DEM)    |
| transformed aspect at 1.5 m (5 ft) scale                             | DEM                              |
| topographic position index, TPI at 1.5m (5 ft) scale (m)             | DEM                              |
| slope at 61 m (200 ft) scale                                         | DEM                              |
| transformed aspect at 61 m (200 ft) scale                            | DEM                              |
| topographic position index, TPI at 61 m (200 ft) scale (m)           | DEM                              |
| elevation (hundreds of meters)                                      | DEM                              |
| Sugar (standardized index)                                           | AVIRIS-NG                        |
| lignin (standardized index)                                          | AVIRIS-NG                        |
| chlorophyll (standardized index)                                     | AVIRIS-NG                        |
| leaf mass per area (standardized index)                              | AVIRIS-NG                        |
| total phenolics (standardized index)                                 | AVIRIS-NG                        |
| nitrogen (standardized index)                                        | AVIRIS-NG                        |
| percent impervious within 20 m                                       | landcover map citep:erker_e_2019 |
| percent impervious within 100 m                                      | landcover map citep:erker_e_2019 |

The total number of trees used in the study was approximately 21
thousand.  We fit several multiple linear regressions with growth rate
as a response and all covariates as predictors with various
interactions that were reasonable given our objectives.  We used AIC
to help with model selection, but did not test very many interactions,
instead we were primarily guided by our objectives and the goal of
finding a model that was straightforward to communicate.  Details on
the selected models are in results.

** Madison, WI: population and forests
Madison is a city of about 260,000 persons ([[https://www.census.gov/quickfacts/fact/table/madisoncitywisconsin/LND110210][USCensus]]), located in
south central Wisconsin.  The dominant forest type is broadleaf
deciduous.  Pre-European settlement forests were dominated by oaks
(Quercus), maples (Acer), and basswood (Tilia).  Now the most common
street tree genera are Fraxinus, Acer, Gleditsia, and Tilia, making up
over 70% of all street trees.  Other common genera in neighborhoods
include: Picea, Thuja, Betula, and Pinus.

** Data
*** Tree inventories
The genus of a tree is the sum of a suite of genetic factors that
affect growth rates and is therefore important to know when modeling
tree growth.  We used four tree inventories for genus information.
The first is the city of Madison's street tree inventory from 2011;
the second is the 2012 inventory of the Atwood neighborhood located on
Madison's east side and the north side of lake Monona, the third is
the 2015-2016 inventory of the Hill Farms neighborhood on Madison's
west side, the fourth is the Village of Shorewood's 2015 street tree
inventory.  The street tree inventories also provided information on
...
conditions.  Over this 12 year period lidar technology greatly
improved and pulse density increased from an average of 0.20 pulses per meter
squared in 2005 to an average of 4 pulses per meter squared in 2017.
Lidar data is available from the wisconsinview [[ftp://ftp.ssec.wisc.edu/pub/wisconsinview/lidar/Dane/][ftp server]].

We extracted lidar point clouds surrounding the tree points in the
tree inventories with a 2.4 m buffer.  The buffer width was selected
...
excluded.  This worked well for the vast majority of trees since most
tree points were in the center of the crown.  We dropped trees from
the analysis that had been removed during the study period or that
were too close to other trees and could cause possible confusion.  If
two trees were within 5 m of each other we selected the tree with the
larger diameter and dropped the other.  We analyzed the lidar data
using the R package =lidR= citep:roussel_auty_2018.
...
In September 2015, NASA's Airborne Visible / Infrared Imaging
Spectrometer - Next Generation (AVIRIS-NG) collected imagery over the
majority of Madison.  AVIRIS-NG collects solar reflectance in 5 nm
bands from 400 nm to 2500 nm.  The spatial resolution of the imagery
was 4.6 m.  
...
area (g/m^2), LMA (g / m^2); lignin (% mass), chlorophyll (mmol / m^2), and
total phenolics (% mass).  We converted these trait predictions to an
index because of imagery differences between our site and where the
model was built meant that predictions were biased and not quite
within biologically reasonable ranges.  To create this index we
adjusted traits predictions across images using overlap pixels to be
consistent across images and then standardized the traits by dividing
...
from lidar to mask any pixels that had a mean height less than 8
...
AVIRIS-NG imagery that made distinguishing crown boundaries difficult.
...
We created a canopy height model at 1 m spatial resolution using the
2016 lidar.  We then found the average height of that canopy height
model within 20 m of each tree and used this as a variable to
approximate competition for light.

Using a 1 m landcover map for the city of Madison, we calculated the
percent impervious cover within 20 m and within 100 m of each tree
citep:erker_e_2019.
...
The estimated maximum height of trees derived from lidar is always lower
than the true maximum height, that is, it is biased downward.  The
magnitude of this bias is a function of the lidar and the tree
...
close to the highest branch of the tree citep:roussel_e_2017.  Twig
size also plays a role. Generally, taxa with thinner twigs have denser
branching so while a single twig may not reflect enough energy from a
lidar pulse to trigger a return, there are many more twigs close
together.  Taxa with thicker twigs will have stronger returns, but
since thicker twigs tend to be less dense, the probability of hitting
a thick twig is lower.  Exactly how these negatively correlated traits
(twig thickness and density) interact to influence the bias in maximum
height estimates is mediated by the algorithms used to convert full
waveform lidar into point clouds.  Thus, in our attempt to correct for
the bias in maximum height estimation and - by extension across
multiple years - tree height growth, we used a bootstrap resampling
technique to estimate bias at different pulse densities for each
genera in our dataset.  Other characteristics of the lidar, such as
footprint size are important in correcting bias, but we did not have
this information for all our datasets and could not correct for it
citep:anderson_e_2006. 


Our goal is to estimate tree growth from multiple years of lidar.  The
primary issue with this endeavor is that tree growth and the size of
the bias are confounded (figure [[fig:example_tilia]]).  In 2005, average
pulse density was very low and so bias was large.  By 2017, average
pulse density had increased and so bias decreased.  The challenge
therefore is to identify how much of the observed maximum height
difference is due to growth over those 12 years and how much is due to
a decrease in bias.

#+name: fig:example_tilia
#+caption: Example Tilia tree showing the confounding between tree growth and pulse density through time.
[[file:figs/ST42874.png]]
#+name: fig:example_tenneyoak
#+caption: Example very large Quercus tree showing increasing pulse density through time.  We assume this tree has stopped height growth and any difference in height between years is due to measurement error primarily driven by pulse density.
[[file:figs/tenney_oak1.png]]
...
genera that had essentially reached their maximum height and stopped
...
We then averaged the bias curves for each genera (Figure
[[fig:mean_pulse_by_bias_by_genus]]) and applied this mean
...
growth rate for each tree (Figure [[fig:year_by_height]]).  The advantage
of the weighted regression is that we were able to include data points
in the regression even if they were highly uncertain rather than
removing them completely.  Lidar from 2005 generally is very sparse in
density, but there were some trees for which the sample size was
sufficiently large to provide some information on growth.
...
and [[fig:year_by_height]].  Figure [[fig:pulse_by_bias_by_genus]] demonstrates
...
resampled at many densities each 1000 times.  Bias curves were created
...
there are times when the bias is over-corrected (see "ST03542" and
"ST20636"). Weighting years in the regression by their bias correction
uncertainty can diminish the over-correction issues, but some years
will be over-corrected (likely "ST05216") and some will be
...
12.8 cm per year. Performing an unweighted regression for each tree
with no bias correction, the growth rate was 22.8 cm per year.
Without the weighted regression but with the bias correction the mean
growth rate was 8.7 cm per year.  We only analyzed in depth the bias
...
#+caption: Histogram of estimated growth rates for over 21 thousand urban trees.  The sample mean growth rate is 12.8 cm / year.
[[file:figs/growthrate_histogram_w.png]]

** Multiple linear regression results

After plotting the data and testing for various interactions we
settled on two models to communicate the results.  The first contains
interactions between some covariates, but is still relatively simple.
The second adds interactions between genus and many of the covariates
to the first model. The first model contained a fourth order
polynomial term for the 2005 height covariate, an interaction between
2005 height and the neighborhood/street/utility line indicator
variable, and an interaction between the two scales of percent
impervious cover. It identified broad patterns between covariates and
growth rates for all trees in our sample.  For the second model we
interacted the genus covariate with the intercept and all the
covariates except the topographic ones.  The second model that
included genus had a much improved AIC (2123 less with 315 more
parameters) and a higher adjusted R^2 (.556 compared to .50).  There
are clearly differences between genera in covariate coefficients.

The first model had 27 parameters shown in table
...
more interaction terms and performing more model selection, but we
wanted to keep the model within our existing hypotheses and
easily explainable.
...
The strongest predictor of growth rate was the bias corrected height
of a tree in 2005 (figure [[fig:growthrate_byheight_byneighst]]).
Neighborhood trees grew significantly faster than street trees (about
3 - 8 cm more per year across the range of tree heights observed).
Overhead utility lines did not have a significant effect on growth
rates when averaging across all genera.  At a height of 8m,
neighborhood trees were growing at an estimated 32 cm / year and
street trees at an estimated 25 cm / year.  Depending on the type of
tree, asympotitc heights are different.  For street trees with
utilities overhead it occurred at heights around 24 m; for street trees
without utilities: 25 m; for neighborhood trees: 26 m.
...
impervious cover at either scales had growth rates of around 12 cm /
year.  Trees with very high impervious cover at both scales had low
growth rates, as low as 2.5 cm / year.  But the combination of
impervious cover at the two scales which lead to the highest growth
rates (around 13 - 14 cm / year) was low impervious cover within 20m
and high impervious cover within 100m.  This situation might occur for
trees in small parks or yards surrounded by built up surfaces.  

Growth rates of trees with little impervious cover within 100 m are
similar regardless of the impervious cover within the nearest 20 m.
But the growth rates of trees with much impervious cover within 100 m
are very strongly influenced by the local impervious cover within 20 m.

#+name: fig:impervious_interactions
#+caption: Estimated height growth rates for trees with varying percent impervious land cover within 20 m and within 100m.  All other covariates are at their median values.
[[file:figs/impervious_street_neighborhood_ribbon.png]]
** Topography

Topographic variables had statistically clear, but small effects on
growth rates.  Figure [[fig:topography_coef]] shows the coefficient
estimates for the variables at the two scales.  Elevation in Madison
had a significant relationship with growth.  Elevation in the city
ranges from around 250 m to 350 m.  Our model estimated that trees
growing in the highest parts of the city grew about 1.4 cm / year more
than trees growing in the lowest parts of the city.  While trees at
higher elevations grew faster than trees at lower elevations,
topographic position index was associated with less growth.  At the
scale of 1.5 m, for every 1m that trees are higher than their
surroundings they grew an estimated 1.75 cm less per year.  Aspect and
slope was not significant at the 61 m scale, but at the 1.5 m scale
trees on steeper slopes grew more slowly than trees in flatter
regions and trees in the northeast aspect grew faster than trees in
the southwest aspect by almost 1 cm / year.
...
The mean height within 20 m of a tree had a strong effect on growth
rates.  Trees that must compete for light allocate more resources to
growing up.  For every meter increase in mean height around a tree,
the growth rate increased by .85 cm.  For example, we estimated an
open grown tree in a park would grow about 8 cm less per year than a
tree grown in an area with a mean height of about 10 m (for example
near buildings and other trees).  
...
were suppressed or over-topped.  

Figure [[fig:mean_height_20m_coefs]] shows coefficient estimates with 95%
confidence intervals for the first model ("overall") and for second
model which includes estimates by genus.  There is no clear difference
in the effect of the mean height within 20 m by Genus.

#+name: fig:mean_height_20m_coefs
#+caption: Coefficients for mean height within 20 m by genus and overall.
[[file:figs/mean_height_20m_coefs.png]]
** Foliar canopy traits

Four of the six foliar canopy traits were significantly related to
tree height growth. Total phenolics, lignin and nitrogen had a negative
association with growth; chlorophyll had a positive association, sugar
and leaf mass per area had no association.  There is considerable
variability by genus in the trait coefficients (Figure
[[fig:trait_coefs]]).  Applying Tukey's correction for multiple
...
genus is clear.  Traits are scaled indicies and so estimate units are
difficult to interpret.  Estimates correspond to growth rate change
with one standard deviation change in the trait index.

Growth rates are significantly related some of the traits, but they have little
predictive power in our model.  Their contribution to the model also
greatly depends on whether or not genus is included.  They slightly
budge the adjusted R^2 from .54 to .56 for the model with genus.  But
they increase the adjusted R^2 from .12 to .5 for a model without genus
but with other covariates.  If traits are the only covariates the
adjusted R^2 is just .04.  Therefore traits alone cannot explain height
growth, but they can explain much of the variability explained by genus.

#+name: fig:trait_coefs
#+caption: Estimates of trait coefficients.  Estimates from model without genus are shown in black.  Estimates by genus are shaded.
[[file:figs/traits_coef_comparison.png]]

** Marginal Means by Genus
Much of the differences in height growth rates can be explained by the
genus.  Figure [[fig:marginal_growthrate_genus]] shows the estimated
marginal mean growth rates by genus.  Shaded bars are 95% confidence
intervals and red arrows provide a guideline for pairwise comparisons
that accounts for multiple comparisons.  The three gymnosperms in the
dataset, Pinus, Picea and Ginkgo, have some of the highest estimated
growth rates (all over 20 cm / year, though Ginkgo has high
uncertainty).  Other fast growing genera are Ulmus, Tilia, Populus,
and Carya (estimated marginal growth rates over 17.5 cm / year).
Quercus, Juglans, Celtis and Acer had slow growth (estimated marginal
growth rates less than 12 cm / year.

#+name: fig:marginal_growthrate_genus
#+caption:  Estimated marginal mean growth rates by genus.  Shaded bars are 95% confidence intervals and red arrows provide a guideline for pairwise comparisons that accounts for multiple comparisons.
[[file:figs/genus_comparisons_full model.png]]
** Genus by Height predicted growth rates

Marginal mean growth rates by genera are illustrated of overall
differences, but do not show how growth rates vary with height and
with neighborhood/street tree by genus (figures
...
decline varies by genus.  Populus has the fastest estimated growth at
8 m heights, while Pinus has the fastest growth at 20 m heights.
Ulmus and Quercus are fast growing when trees are small, but rapidly
decline in growth rates as height increases.
...
utility line).  Figure [[fig:growthrate_height_3genera_stpo]] shows that
while the relationship between growth rate and height is very similar
for Acer, Fraxinus, and Gleditisia if they are neighborhood trees, but
if the trees are planted on streets the relationship is very
different.  When a tree is planted on a street growth rates are lower
than for neighborhood trees, but the difference is greatest for Acer followed by
Fraxinus and then Gleditsia.  Overhead utility lines had little
association with decreased height growth (except perhaps for Pinus).
...
#+caption: Growth rates are associated with a three way interaction between height in 2005, genus, and type of tree.  
[[file:figs/height_genus_int_stpo_genussub1.png]]
...
The negative bias in height estimates from lidar is well known and
creates challenges in using multi-temporal lidar to estimate forest
parameters citep:marinelli_e_2019.  This is especially true for
individual trees compared to larger forest stands
...
pulse density was 52 pulses / m^2) was 2 +/- 19 cm m^{-2} yr^{-1}, and from
2004-2008 (when pulse density increased from 11 to 52 pulses / m^2)
mean growth was 37 +/- 14 m m^{-2} yr^{-1}.  So when pulse density was
...
cite:roussel_e_2017 described a method to correct for maximum height
bias and our method was in many ways very similar to theirs.  They
proposed using a high resolution point cloud to help correct a low
resolution point cloud.  But a high resolution point cloud is usually
not available. They proposed using an area of high pulse density as a
reference and then applying the bias correction relationship to areas
of low pulse density.  They pointed out that not only is there bias in
height for multi-temporal lidar, but also within single date lidar
because of the variation in pulse density across space.  They mostly
described the nature of the bias, but leave application of correction
to others.

Our method assumed that point clouds from multiple years for trees
...
it is available to validate this method.
...
gymnosperms, had greater bias cite:roussel_e_2017.  It also appeared
...
While pulse density is a key factor in height bias, here are other
important sources of bias that our method ignores, namely lidar pulse
footprint size.  We did not have footprint size information for the
2005 lidar and future work should include it in bias corrections.
...
Foliar canopy traits predicted from imaging spectroscopy we
significantly related to tree height growth, and they appeared to
encode much of the information included in a tree's genus.  Models
that contained genus as a term had the greatest explanatory power,
however taxonomic information is often missing for trees, especially
in neighborhoods on private property.  The foliar canopy traits show
promise in improving canopy height predictions when genus is not know.
...
photosynthesis, was positively associated with growth.  Lignin and
total phenolics, compounds generally associated with plant structure
and defense were negatively associated with growth.  This is expected
since allocation of resources to leaf structure and defense implies
less allocation to growth.

The coefficient for nitrogen was negative, which was surprising for
a couple reasons.  First, about 10% - 25% of foliar nitrogen is in
Rubisco, the enzyme responsible for carbon fixation.  Plants with
higher nitrogen generally grow faster (up to a point).  Second,
nitrogen had a strong positive correlation to chlorophyll, which had a
positive coefficient.  But dropping chlorophyll or other traits from
the model does not affect the direction of the nitrogen coefficient,
suggesting that multicollinearity is not a problem.   

Why increasing foliar nitrogen could be associated with a decrease in
growth is not immediately clear.  An easy first explanation could be
that the predictive models for the imaging spectroscopy are faulty.  A
second biological explanation could be that nitrogen deposition is
increasing foliar nitrogen in the urban environment, but that nitrogen
is not limiting growth.  The deposition of nitrogen could be
associated with other pollutants that negatively impact growth.  The
negative association of nitrogen with growth does not appear to be a
statistical anomaly, but the driver behind the relationship is not
clear and should be further investigated.

** Environmental effects on tree height growth.

We tested the relationship between three groups of variables on tree
height growth: mean height of a tree's surroundings, nearby impervious
landcover percentage, and topography.  All three had statistically
significant effects, though the effect of topography was small.
...
where they are competing for light.  Most trees in yards and on streets
are more open grown and are shorter.  Future work should separate out
buildings from trees in the surroundings of a tree and test whether
the faster height growth is in response to nearby buildings as well as
trees. 
...
because it is associated with a number of stressors like poor or
insufficient soil.  However, we found that trees that had little
impervious cover within 20 m and much impervious cover within 100 m
grew fastest.  This could possibly be because trees had sufficient
soil locally and may have been receiving increased water from runoff
or were responding to the elevated temperatures in the broader
surroundings.

Topographic relationships with growth rate seem to be due to water:
trees on less steep slopes, cooler and wetter northeast aspects, and
lower elevation relative to their immediate surroundings all grew more
than trees in the opposite conditions.  Why trees at higher elevations
grew more than trees at lower elevations is not clear, but could be
due to another factor that varies from the relatively lower eastern
half of the city to the relatively higher western half of the city,
such as soils.   

** COMMENT Future work


Spatial structure to the errors.

Map 
looking at residuals of the models shows significant remaining spatial structure:

- the west side of madison has elevated growth rates beyond expected
  by the model
- blocks of trees are often all positive or all negative and their residuals.
the we
...
from low lidar pulse density and more accurately estimate tree height
growth with multiple years of lidar.  Second, we show that for urban
trees, as for all trees, height growth is significantly related to
height and genus.  Important for broader applications, we show that if
genus information is not available foliar canopy traits derived from
imaging spectroscopy can explain much of the variation in height
growth rates that would otherwise be explained by genus.  Third, we
show that the urban environment, namely the height of a tree's
surroundings, the percent impervious, and the topography all are
associated with changes in tree height growth rates.

Urban trees alter the urban environment, potentially providing city
dwellers with both services.  Our work has shown that the growth of
trees - and the growth related services - may in turn be affected by
the urban environment designed by humans, particularly impervious
