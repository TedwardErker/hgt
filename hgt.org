...
citep:king_1990.  Trees surrounded by tall objects will need to grow
tall to capture energy.  Impervious surfaces and utility presence are
associated with poor tree growth and mortality
citep:jim_1998,day_e_2010.
...
| Covariate                                                      | Source                                     | method                |
|----------------------------------------------------------------+--------------------------------------------+-----------------------|
| Bias corrected height in 2005 (m)                              | LiDAR                                      | this paper            |
| Mean of height within 20 m (m)                                 | 2016 LiDAR derived 1 m canopy height model | this paper            |
| Genus                                                          | tree inventories                           |                       |
| neighborhood or street tree with or without overhead utilities | tree inventories                           |                       |
| slope  at 1.5 m (5 ft) scale                                   | 1.5 m Digital Elevation Model (DEM)        | citep:raster_Rpackage |
| transformed aspect at 1.5 m (5 ft) scale                       | 1.5 m DEM                                  | citep:beers_e_1966    |
| topographic position index, TPI at 1.5m (5 ft) scale (m)       | 1.5 m DEM                                  | citep:raster_Rpackage |
| slope at 61 m (200 ft) scale                                   | 1.5 m DEM                                  | citep:raster_Rpackage |
| transformed aspect at 61 m (200 ft) scale                      | 1.5 m DEM                                  | citep:beers_e_1966    |
| topographic position index, TPI at 61 m (200 ft) scale (m)     | 1.5 m DEM                                  | citep:raster_Rpackage |
| elevation (hundreds of meters)                                 | 1.5 m DEM                                  |                       |
| Sugar (standardized index)                                     | 4.6 m AVIRIS-NG                            | citep:singh_e_2015    |
| lignin (standardized index)                                    | 4.6 m AVIRIS-NG                            | citep:singh_e_2015    |
| chlorophyll (standardized index)                               | 4.6 m AVIRIS-NG                            | citep:singh_e_2015    |
| leaf mass per area (standardized index)                        | 4.6 m AVIRIS-NG                            | citep:singh_e_2015    |
| total phenolics (standardized index)                           | 4.6 m AVIRIS-NG                            | citep:singh_e_2015    |
| nitrogen (standardized index)                                  | 4.6 m AVIRIS-NG                            | citep:singh_e_2015    |
| percent impervious within 20 m                                 | 1 m landcover map                          | citep:erker_e_2019    |
| percent impervious within 100 m                                | 1 m landcover map                          | citep:erker_e_2019    |

For the purposes of estimating coefficients more reliably, we subset
our data for statistical analyses so that no two trees of the same
genus were closer than 200 m to one another.  This reduced our sample
size from 21,247 to 7,124, but also reduced spatial dependence that
could potentially bias coefficient estimates or inflate confidence
that coeffient estimates were different from zero.  We fit several
multiple linear regressions with growth rate as a response and all
covariates as predictors with plausible interactions.  We used AIC to
help with model selection, but did not test very many interactions,
...
in south central Wisconsin, USA, (figure [fig:studyarea]],
...
** Data
*** Tree inventories
We used four tree inventories for genus information.  The first is the
city of Madison's street tree inventory from 2011; the second is the
...
inventory of the Hill Farms neighborhood on Madison's west side, the
fourth is the Village of Shorewood's 2015 street tree inventory.  The
street tree inventories also provided information on presence of
